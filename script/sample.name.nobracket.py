...
bracketPram1 = part.# [Removed: bracket creation block]
part.BlankElement(bracket1,True)
part.SetElementColor(bracket1,"0","255","255","0.19999998807907104")
separated_bodies1 = part.BodyDivideByCurves("Separe body by curves42",bracket1,[skt_pl3],False,"0","","",False)
...
# [Removed: bracket parameter attribute]
# [Removed: bracket parameter attribute]
...
bracketPram2 = part.# [Removed: bracket creation block]
part.BlankElement(bracket2,True)
part.SetElementColor(bracket2,"0","255","255","0.19999998807907104")
separated_bodies2 = part.BodyDivideByCurves("Separe body by curves32",bracket2,[skt_pl3],False,"0","","",False)
...
bracketPram3 = part.# [Removed: bracket creation block]
...
bracketPram4 = part.# [Removed: bracket creation block]
...
separated_bodies5 = part.BodyDivideByCurves("Separe body by curves59",profile13[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies5[0],"148","0","211","0.39999997615814209")
...
bracketPram5 = part.# [Removed: bracket creation block]
part.BlankElement(bracket5,True)
part.SetElementColor(bracket5,"0","255","255","0.19999998807907104")
separated_bodies7 = part.BodyDivideByCurves("Separe body by curves13",bracket5,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies7[0],"0","255","255","0.19999998807907104")
bracketPram6 = part.# [Removed: bracket creation block]
...
ProfilePram26.BasePlane="PL,O,"+var_elm5+","+"Y"
ProfilePram26.AddAttachSurfaces(extrude_sheet4)
ProfilePram26.ProfileName="HK.Casing.Deck.D.DL01.AP"
...
ProfilePram26.AddEnd1Elements(extrude_sheet3)
ProfilePram26.End1Type=1102
ProfilePram26.End1TypeParams=["25","29.999999999999996","0","0"]
ProfilePram26.AddEnd2Elements(profile22[0])
...
ProfilePram27.BasePlane="PL,O,"+var_elm5+","+"Y"
ProfilePram27.AddAttachSurfaces(extrude_sheet3)
ProfilePram27.ProfileName="HK.Casing.Wall.Aft.DL01.CDP"
...
bracketPram7 = part.# [Removed: bracket creation block]
part.BlankElement(bracket7,True)
part.SetElementColor(bracket7,"0","255","255","0.19999998807907104")
separated_bodies8 = part.BodyDivideByCurves("Separe body by curves56",bracket3,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies8[0],"0","255","255","0.19999998807907104")
...
bracketPram8 = part.# [Removed: bracket creation block]
part.BlankElement(bracket8,True)
part.SetElementColor(bracket8,"0","255","255","0.19999998807907104")
separated_bodies11 = part.BodyDivideByCurves("Separe body by curves16",bracket8,[skt_pl3],False,"0","","",False)
...
bracketPram9 = part.# [Removed: bracket creation block]
part.BlankElement(bracket9,True)
part.SetElementColor(bracket9,"0","255","255","0.19999998807907104")
separated_bodies13 = part.BodyDivideByCurves("Separe body by curves46",bracket9,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies13[0],"0","255","255","0.19999998807907104")
bracketPram10 = part.# [Removed: bracket creation block]
part.BlankElement(bracket10,True)
part.SetElementColor(bracket10,"0","255","255","0.19999998807907104")
separated_bodies14 = part.BodyDivideByCurves("Separe body by curves36",bracket10,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies14[0],"0","255","255","0.19999998807907104")
...
separated_bodies16 = part.BodyDivideByCurves("Separe body by curves39",profile27[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies16[0],"255","0","0","0.19999998807907104")
bracketPram11 = part.# [Removed: bracket creation block]
part.BlankElement(bracket11,True)
part.SetElementColor(bracket11,"0","255","255","0.19999998807907104")
separated_bodies17 = part.BodyDivideByCurves("Separe body by curves43",bracket11,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies17[0],"0","255","255","0.19999998807907104")
separated_bodies18 = part.BodyDivideByCurves("Separe body by curves55",bracket6,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies18[0],"0","255","255","0.19999998807907104")
...
bracketPram12 = part.# [Removed: bracket creation block]
part.BlankElement(bracket12,True)
part.SetElementColor(bracket12,"0","255","255","0.19999998807907104")
bracketPram13 = part.# [Removed: bracket creation block]
...
bracketPram14 = part.# [Removed: bracket creation block]
...
bracketPram15 = part.# [Removed: bracket creation block]
...
bracketPram19 = part.# [Removed: bracket creation block]
part.BlankElement(bracket19,True)
part.SetElementColor(bracket19,"0","255","255","0.19999998807907104")
separated_bodies24 = part.BodyDivideByCurves("Separe body by curves8",bracket19,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies24[0],"0","255","255","0.19999998807907104")
...
bracketPram20 = part.# [Removed: bracket creation block]
...
bracketPram21 = part.# [Removed: bracket creation block]
part.BlankElement(bracket21,True)
part.SetElementColor(bracket21,"0","255","255","0.19999998807907104")
separated_bodies29 = part.BodyDivideByCurves("Separe body by curves6",bracket21,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies29[0],"0","255","255","0.19999998807907104")
separated_bodies30 = part.BodyDivideByCurves("Separe body by curves38",bracket18,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies30[0],"0","255","255","0.19999998807907104")
separated_bodies31 = part.BodyDivideByCurves("Separe body by curves29",bracket7,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies31[0],"0","255","255","0.19999998807907104")
separated_bodies32 = part.BodyDivideByCurves("Separe body by curves18",bracket15,[skt_pl3],False,"0","","",False)
...
separated_bodies34 = part.BodyDivideByCurves("Separe body by curves50",bracket12,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies34[0],"0","255","255","0.19999998807907104")
...
separated_bodies39 = part.BodyDivideByCurves("Separe body by curves48",bracket4,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies39[0],"0","255","255","0.19999998807907104")
...
bracketPram22 = part.# [Removed: bracket creation block]
part.BlankElement(bracket22,True)
part.SetElementColor(bracket22,"0","255","255","0.19999998807907104")
bracketPram23 = part.# [Removed: bracket creation block]
part.BlankElement(bracket23,True)
part.SetElementColor(bracket23,"0","255","255","0.19999998807907104")
separated_bodies41 = part.BodyDivideByCurves("Separe body by curves10",bracket23,[skt_pl3],False,"0","","",False)
...
separated_bodies44 = part.BodyDivideByCurves("Separe body by curves26",profile26[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies44[0],"255","0","0","0.19999998807907104")
separated_bodies45 = part.BodyDivideByCurves("Separe body by curves47",bracket20,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies45[0],"0","255","255","0.19999998807907104")
...
separated_bodies48 = part.BodyDivideByCurves("Separe body by curves33",bracket22,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies48[0],"0","255","255","0.19999998807907104")
...
separated_bodies53 = part.BodyDivideByCurves("Separe body by curves45",bracket13,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies53[0],"0","255","255","0.19999998807907104")
separated_bodies54 = part.BodyDivideByCurves("Separe body by curves35",bracket14,[skt_pl3],False,"0","","",False)
...
separated_bodies59 = part.BodyDivideByCurves("Separe body by curves17",bracket17,[skt_pl3],False,"0","","",False)
