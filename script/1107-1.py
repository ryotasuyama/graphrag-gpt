...
separated_bodies46 = part.BodyDivideByCurves("Separe body by curves58",profile10[1],[skt_pl3],False,"0","","",False)
...
separated_bodies49 = part.BodyDivideByCurves("Separe body by curves25",profile5[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies49[0],"255","0","0","0.19999998807907104")
separated_bodies50 = part.BodyDivideByCurves("Separe body by curves22",profile2[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies50[0],"255","0","0","0.19999998807907104")
separated_bodies51 = part.BodyDivideByCurves("Separe body by curves24",profile29[0],[skt_pl3],False,"0","","",False)
...
# =========================
# 追加: ブラケット(台形板)の作成
# - 1501: プロファイル-板(デッキ/壁)接続
# - 1505: プロファイル-プロファイル接続
# =========================

# 共通パラメータ(厚み・素材・モールド)
def make_bracket_color(elem):
    part.BlankElement(elem, True)
    part.SetElementColor(elem, "180", "180", "30", "0.69999998807907104")

# 1) 壁側プロファイル(FR13.CDP) ↔ デッキC(板) [1501]
brk1 = part.CreateBracketParam()
brk1.DefinitionType = 1
brk1.BracketType = 1501
brk1.BracketName = "HK.BRK.FR13_to_DeckC"
brk1.MaterialName = "SS400"
brk1.Thickness = "10"
brk1.Mold = "+"
brk1.MoldOffset = "0"
# プロファイル-板の接続: BaseElementにプロファイル, Surfaces1に板
brk1.BaseElement = profile15[0]        # HK.Casing.Wall.Side.FR13.CDP
brk1.Surfaces1 = [extrude_sheet1]      # Deck C sheet
brk1.BracketParams = ["350","220","30","20","0"]
brk1.UseSideSheetForPlane = False
brk_elem1 = part.CreateBracket(brk1, False)
make_bracket_color(brk_elem1)

# 2) デッキFR09P(プロファイル) ↔ 側壁P(板) [1501]
brk2 = part.CreateBracketParam()
brk2.DefinitionType = 1
brk2.BracketType = 1501
brk2.BracketName = "HK.BRK.FR09P_to_SideWallP"
brk2.MaterialName = "SS400"
brk2.Thickness = "10"
brk2.Mold = "+"
brk2.MoldOffset = "0"
brk2.BaseElement = profile21[0]        # HK.Casing.Deck.D.FR09P
brk2.Surfaces1 = [extrude_sheet6]      # Wall Side P sheet
brk2.BracketParams = ["300","200","25","20","0"]
brk2.UseSideSheetForPlane = False
brk_elem2 = part.CreateBracket(brk2, False)
make_bracket_color(brk_elem2)

# 3) デッキFR09C(プロファイル) ↔ Fore壁(板) [1501]
brk3 = part.CreateBracketParam()
brk3.DefinitionType = 1
brk3.BracketType = 1501
brk3.BracketName = "HK.BRK.FR09C_to_ForeWall"
brk3.MaterialName = "SS400"
brk3.Thickness = "10"
brk3.Mold = "+"
brk3.MoldOffset = "0"
brk3.BaseElement = profile22[0]        # HK.Casing.Deck.D.FR09C
brk3.Surfaces1 = [extrude_sheet2]      # Fore wall sheet
brk3.BracketParams = ["320","210","25","20","0"]
brk3.UseSideSheetForPlane = False
brk_elem3 = part.CreateBracket(brk3, False)
make_bracket_color(brk_elem3)

# 4) Aft壁DL02(プロファイル) ↔ デッキD(板) [1501]
brk4 = part.CreateBracketParam()
brk4.DefinitionType = 1
brk4.BracketType = 1501
brk4.BracketName = "HK.BRK.WallAft_DL02_to_DeckD"
brk4.MaterialName = "SS400"
brk4.Thickness = "10"
brk4.Mold = "+"
brk4.MoldOffset = "0"
brk4.BaseElement = profile10[0]        # HK.Casing.Wall.Aft.DL02.CDP (web側)
brk4.Surfaces1 = [extrude_sheet4]      # Deck D sheet
brk4.BracketParams = ["300","180","20","15","0"]
brk4.UseSideSheetForPlane = False
brk_elem4 = part.CreateBracket(brk4, False)
make_bracket_color(brk_elem4)

# 5) デッキFR13C(プロファイル) ↔ 側壁FR13.CDP(プロファイル) [1505]
brk5 = part.CreateBracketParam()
brk5.DefinitionType = 1
brk5.BracketType = 1505
brk5.BracketName = "HK.BRK.FR13_Deck_to_Wall"
brk5.MaterialName = "SS400"
brk5.Thickness = "10"
brk5.Mold = "+"
brk5.MoldOffset = "0"
# プロファイル-プロファイル接続: Sf1BaseElementsとSf2BaseElementsを使用
brk5.Sf1BaseElements = [profile7[0]]   # Deck FR13C
brk5.Sf2BaseElements = [profile15[0]]  # Wall FR13.CDP
brk5.BracketParams = ["260","260","25","20","0"]
brk5.UseSideSheetForPlane = False
brk_elem5 = part.CreateBracket(brk5, False)
make_bracket_color(brk_elem5)

# 6) デッキFR09P(プロファイル) ↔ 側壁FR09.CDP(プロファイル) [1505]
brk6 = part.CreateBracketParam()
brk6.DefinitionType = 1
brk6.BracketType = 1505
brk6.BracketName = "HK.BRK.FR09_Deck_to_Wall"
brk6.MaterialName = "SS400"
brk6.Thickness = "10"
brk6.Mold = "+"
brk6.MoldOffset = "0"
brk6.Sf1BaseElements = [profile21[0]]  # Deck FR09P
brk6.Sf2BaseElements = [profile23[0]]  # Wall FR09.CDP
brk6.BracketParams = ["240","240","22","18","0"]
brk6.UseSideSheetForPlane = False
brk_elem6 = part.CreateBracket(brk6, False)
make_bracket_color(brk_elem6)

# 7) デッキFR13P(プロファイル) ↔ 側壁P(板) [1501]
brk7 = part.CreateBracketParam()
brk7.DefinitionType = 1
brk7.BracketType = 1501
brk7.BracketName = "HK.BRK.FR13P_to_SideWallP"
brk7.MaterialName = "SS400"
brk7.Thickness = "10"
brk7.Mold = "+"
brk7.MoldOffset = "0"
brk7.BaseElement = profile14[0]        # Deck FR13P
brk7.Surfaces1 = [extrude_sheet6]      # Side wall P sheet
brk7.BracketParams = ["320","200","25","20","0"]
brk7.UseSideSheetForPlane = False
brk_elem7 = part.CreateBracket(brk7, False)
make_bracket_color(brk_elem7)

# 8) Aft壁DL04(プロファイル) ↔ デッキD(板) [1501]
brk8 = part.CreateBracketParam()
brk8.DefinitionType = 1
brk8.BracketType = 1501
brk8.BracketName = "HK.BRK.WallAft_DL04_to_DeckD"
brk8.MaterialName = "SS400"
brk8.Thickness = "10"
brk8.Mold = "+"
brk8.MoldOffset = "0"
brk8.BaseElement = profile3[0]         # HK.Casing.Wall.Aft.DL04.CDP
brk8.Surfaces1 = [extrude_sheet4]      # Deck D sheet
brk8.BracketParams = ["300","180","20","15","0"]
brk8.UseSideSheetForPlane = False
brk_elem8 = part.CreateBracket(brk8, False)
make_bracket_color(brk_elem8)

# 9) デッキDL01(プロファイル) ↔ Fore壁(板) [1501]
brk9 = part.CreateBracketParam()
brk9.DefinitionType = 1
brk9.BracketType = 1501
brk9.BracketName = "HK.BRK.Deck_DL01_to_ForeWall"
brk9.MaterialName = "SS400"
brk9.Thickness = "10"
brk9.Mold = "+"
brk9.MoldOffset = "0"
brk9.BaseElement = profile8[0]         # HK.Casing.Deck.D.DL01.FP
brk9.Surfaces1 = [extrude_sheet2]      # Fore wall sheet
brk9.BracketParams = ["260","180","22","18","0"]
brk9.UseSideSheetForPlane = False
brk_elem9 = part.CreateBracket(brk9, False)
make_bracket_color(brk_elem9)

# 10) 側壁FR11(プロファイル) ↔ デッキC(板) [1501]
brk10 = part.CreateBracketParam()
brk10.DefinitionType = 1
brk10.BracketType = 1501
brk10.BracketName = "HK.BRK.Wall_FR11_to_DeckC"
brk10.MaterialName = "SS400"
brk10.Thickness = "10"
brk10.Mold = "+"
brk10.MoldOffset = "0"
brk10.BaseElement = profile12[0]       # HK.Casing.Wall.Side.FR11.CDP
brk10.Surfaces1 = [extrude_sheet1]     # Deck C sheet
brk10.BracketParams = ["300","180","22","18","0"]
brk10.UseSideSheetForPlane = False
brk_elem10 = part.CreateBracket(brk10, False)
make_bracket_color(brk_elem10)