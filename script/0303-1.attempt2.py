...
bracketPram2.BracketName="HK.Casing.Wall.Fore.DL05.Deck.DP"
bracketPram2.MaterialName="SS400"
bracketPram2.BaseElement=profile32[0]
...
bracketPram2.Surfaces1=[profile32[0]+",FL"]
...
bracketPram4.BracketName="HK.Casing.Wall.Fore.DL03.Deck.DP"
...
bracketPram5.BracketName="HK.Casing.Wall.Fore.DL02.Deck.DP"
bracketPram5.MaterialName="SS400"
bracketPram5.BaseElement=profile59[0]
...
bracketPram5.Surfaces1=[profile59[0]+",FL"]
...
bracketPram6.BracketName="HK.Casing.Wall.Fore.DL00.Deck.DP"
bracketPram6.MaterialName="SS400"
bracketPram6.BaseElement=profile94[0]
...
bracketPram6.Surfaces1=[profile94[0]+",FL"]
bracketPram6.RevSf1=False
bracketPram6.Surfaces2=[profile93[0]+",FL"]
...
bracketPram7.BaseElement=profile75[0]
...
bracketPram7.Surfaces1=[profile75[0]+",FL"]
...
bracketPram9.BracketName="HK.Casing.Wall.Aft.DL03.Deck.DP"
bracketPram9.MaterialName="SS400"
bracketPram9.BaseElement=profile36[0]
...
bracketPram9.Surfaces1=[profile36[0]+",FL"]
...
bracketPram10.BracketName="HK.Casing.Wall.Aft.DL04.Deck.DP"
bracketPram10.MaterialName="SS400"
bracketPram10.BaseElement=profile87[0]
...
bracketPram10.Surfaces1=[profile87[0]+",FL"]
...
bracketPram11.BracketName="HK.Casing.Wall.Aft.DL00.Deck.DP"
bracketPram11.MaterialName="SS400"
bracketPram11.BaseElement=profile121[0]
...
bracketPram11.Surfaces1=[profile121[0]+",FL"]
bracketPram11.RevSf1=False
bracketPram11.Surfaces2=[profile33[0]+",FL"]
...
bracketPram12.BracketName="HK.Casing.Wall.Side.FR07.Deck.DP"
bracketPram12.MaterialName="SS400"
bracketPram12.BaseElement=profile16[0]
...
bracketPram12.Surfaces2=[profile16[0]+",FL"]
...
bracketPram13.BaseElement=profile12[0]
...
bracketPram13.Surfaces2=[profile12[0]+",FL"]
...
bracketPram14.Surfaces2=[profile65[0]+",FL"]
...
bracketPram15.BracketName="HK.Casing.Wall.Side.FR10.Deck.DP"
bracketPram15.MaterialName="SS400"
bracketPram15.BaseElement=profile44[0]
...
bracketPram15.Surfaces2=[profile44[0]+",FL"]
...
bracketPram16.BracketName="HK.Casing.Wall.Side.FR11.Deck.DP"
bracketPram16.MaterialName="SS400"
bracketPram16.BaseElement=profile111[0]
...
bracketPram16.Surfaces2=[profile111[0]+",FL"]
...
bracketPram17.BracketName="HK.Casing.Wall.Side.FR12.Deck.DP"
bracketPram17.MaterialName="SS400"
bracketPram17.BaseElement=profile52[0]
...
bracketPram17.Surfaces2=[profile52[0]+",FL"]
...
bracketPram18.BracketName="HK.Casing.Wall.Side.FR13.Deck.DP"
bracketPram18.MaterialName="SS400"
bracketPram18.BaseElement=profile43[0]
...
bracketPram18.Surfaces1=[profile43[0]+",FL"]
...
bracketPram21.BracketName="HK.Casing.Deck.D.Girder.WF.01"
bracketPram21.MaterialName="SS400"
bracketPram21.BaseElement=profile42[0]
...
bracketPram21.Surfaces1=[profile18[0]+",WF"]
...
bracketPram21.Sf1EndElements=[profile18[1]+",FR"]
...
bracketPram22.BracketName="HK.Casing.Deck.D.Girder.WB.01"
bracketPram22.MaterialName="SS400"
bracketPram22.BaseElement=profile60[0]
...
bracketPram22.Surfaces1=[profile18[0]+",WB"]
bracketPram22.RevSf1=False
bracketPram22.Surfaces2=[profile60[0]+",FL"]
...
bracketPram23.BracketName="HK.Casing.Wall.Side.FR09.Deck.DP.R"
...
bracketPram23.RevSf1=True
bracketPram23.Surfaces2=[profile65[0]+",FL"]
