...
# ===== 追加: ブラケット（1501/1505）を多数作成 =====
# 1) FR13 壁-sideプロファイル と デッキ-sideプロファイルを結ぶ台形板(1501)
bracketPram_fr13 = part.CreateBracketParam()
bracketPram_fr13.DefinitionType=1
bracketPram_fr13.BracketName="BKT.FR13.Side_to_DeckD"
bracketPram_fr13.MaterialName="SS400"
bracketPram_fr13.BaseElement=profile15[0]  # HK.Casing.Wall.Side.FR13.CDP
bracketPram_fr13.UseSideSheetForPlane=False
bracketPram_fr13.Mold="+"
bracketPram_fr13.Thickness="8"
bracketPram_fr13.BracketType=1501
bracketPram_fr13.Scallop1Type=1801
bracketPram_fr13.Scallop1Params=["0"]
bracketPram_fr13.Scallop2Type=0
bracketPram_fr13.Surfaces1=[profile15[0]+",FL"]
bracketPram_fr13.RevSf1=False
bracketPram_fr13.Surfaces2=[profile14[0]+",FL"]  # HK.Casing.Deck.D.FR13P
bracketPram_fr13.RevSf2=False
bracketPram_fr13.RevSf3=False
bracketPram_fr13.Sf1DimensionType=1531
bracketPram_fr13.Sf1DimensonParams=["250","15"]
bracketPram_fr13.Sf2DimensionType=1531
bracketPram_fr13.Sf2DimensonParams=["250","15"]
bkt_fr13 = part.CreateBracket(bracketPram_fr13,False)
part.BlankElement(bkt_fr13,True)
part.SetElementColor(bkt_fr13,"0","255","255","0.19999998807907104")

# 2) FR09 壁-side と デッキ FR09P を結ぶ(1501)
bracketPram_fr9p = part.CreateBracketParam()
bracketPram_fr9p.DefinitionType=1
bracketPram_fr9p.BracketName="BKT.FR09.Side_to_DeckD.P"
bracketPram_fr9p.MaterialName="SS400"
bracketPram_fr9p.BaseElement=profile23[0]  # HK.Casing.Wall.Side.FR09.CDP
bracketPram_fr9p.UseSideSheetForPlane=False
bracketPram_fr9p.Mold="+"
bracketPram_fr9p.Thickness="8"
bracketPram_fr9p.BracketType=1501
bracketPram_fr9p.Scallop1Type=1801
bracketPram_fr9p.Scallop1Params=["0"]
bracketPram_fr9p.Scallop2Type=0
bracketPram_fr9p.Surfaces1=[profile23[0]+",FL"]
bracketPram_fr9p.RevSf1=False
bracketPram_fr9p.Surfaces2=[profile21[0]+",FL"]  # HK.Casing.Deck.D.FR09P
bracketPram_fr9p.RevSf2=False
bracketPram_fr9p.RevSf3=False
bracketPram_fr9p.Sf1DimensionType=1531
bracketPram_fr9p.Sf1DimensonParams=["250","15"]
bracketPram_fr9p.Sf2DimensionType=1531
bracketPram_fr9p.Sf2DimensonParams=["250","15"]
bkt_fr9p = part.CreateBracket(bracketPram_fr9p,False)
part.BlankElement(bkt_fr9p,True)
part.SetElementColor(bkt_fr9p,"0","255","255","0.19999998807907104")

# 3) FR09 壁-side と デッキ FR09C を結ぶ(1505)
bracketPram_fr9c = part.CreateBracketParam()
bracketPram_fr9c.DefinitionType=1
bracketPram_fr9c.BracketName="BKT.FR09.Side_to_DeckD.C"
bracketPram_fr9c.MaterialName="SS400"
bracketPram_fr9c.BaseElement=profile23[0]
bracketPram_fr9c.UseSideSheetForPlane=False
bracketPram_fr9c.Mold="+"
bracketPram_fr9c.Thickness="8"
bracketPram_fr9c.BracketType=1505
bracketPram_fr9c.Scallop1Type=1801
bracketPram_fr9c.Scallop1Params=["0"]
bracketPram_fr9c.Scallop2Type=0
bracketPram_fr9c.Surfaces1=[profile23[0]+",FL"]
bracketPram_fr9c.RevSf1=False
bracketPram_fr9c.Surfaces2=[profile22[0]+",FL"]  # HK.Casing.Deck.D.FR09C
bracketPram_fr9c.RevSf2=False
bracketPram_fr9c.RevSf3=False
bracketPram_fr9c.Sf1DimensionType=1531
bracketPram_fr9c.Sf1DimensonParams=["250","15"]
bracketPram_fr9c.Sf2DimensionType=1531
bracketPram_fr9c.Sf2DimensonParams=["250","15"]
bkt_fr9c = part.CreateBracket(bracketPram_fr9c,False)
part.BlankElement(bkt_fr9c,True)
part.SetElementColor(bkt_fr9c,"0","255","255","0.19999998807907104")

# 4) DL01 壁(Fore) と デッキ DL01 を結ぶ(1501)
bracketPram_dl01 = part.CreateBracketParam()
bracketPram_dl01.DefinitionType=1
bracketPram_dl01.BracketName="BKT.DL01.Fore_to_DeckD"
bracketPram_dl01.MaterialName="SS400"
bracketPram_dl01.BaseElement=profile9[0]   # HK.Casing.Wall.Fore.DL01.CDP
bracketPram_dl01.UseSideSheetForPlane=False
bracketPram_dl01.Mold="+"
bracketPram_dl01.Thickness="8"
bracketPram_dl01.BracketType=1501
bracketPram_dl01.Scallop1Type=1801
bracketPram_dl01.Scallop1Params=["0"]
bracketPram_dl01.Scallop2Type=0
bracketPram_dl01.Surfaces1=[profile9[0]+",FL"]
bracketPram_dl01.RevSf1=False
bracketPram_dl01.Surfaces2=[profile8[0]+",FL"]  # HK.Casing.Deck.D.DL01.FP
bracketPram_dl01.RevSf2=False
bracketPram_dl01.RevSf3=False
bracketPram_dl01.Sf1DimensionType=1531
bracketPram_dl01.Sf1DimensonParams=["200","15"]
bracketPram_dl01.Sf2DimensionType=1531
bracketPram_dl01.Sf2DimensonParams=["200","15"]
bkt_dl01 = part.CreateBracket(bracketPram_dl01,False)
part.BlankElement(bkt_dl01,True)
part.SetElementColor(bkt_dl01,"0","255","255","0.19999998807907104")

# 5) DL02 壁(Aft) と デッキ DL02 を結ぶ(1505)
bracketPram_dl02 = part.CreateBracketParam()
bracketPram_dl02.DefinitionType=1
bracketPram_dl02.BracketName="BKT.DL02.Aft_to_DeckD"
bracketPram_dl02.MaterialName="SS400"
bracketPram_dl02.BaseElement=profile10[0]  # HK.Casing.Wall.Aft.DL02.CDP
bracketPram_dl02.UseSideSheetForPlane=False
bracketPram_dl02.Mold="+"
bracketPram_dl02.Thickness="8"
bracketPram_dl02.BracketType=1505
bracketPram_dl02.Scallop1Type=1801
bracketPram_dl02.Scallop1Params=["0"]
bracketPram_dl02.Scallop2Type=0
bracketPram_dl02.Surfaces1=[profile10[0]+",FL"]
bracketPram_dl02.RevSf1=False
bracketPram_dl02.Surfaces2=[profile6[0]+",FL"]  # HK.Casing.Deck.D.DL02P
bracketPram_dl02.RevSf2=False
bracketPram_dl02.RevSf3=False
bracketPram_dl02.Sf1DimensionType=1531
bracketPram_dl02.Sf1DimensonParams=["220","15"]
bracketPram_dl02.Sf2DimensionType=1531
bracketPram_dl02.Sf2DimensonParams=["220","15"]
bkt_dl02 = part.CreateBracket(bracketPram_dl02,False)
part.BlankElement(bkt_dl02,True)
part.SetElementColor(bkt_dl02,"0","255","255","0.19999998807907104")

# 6) DL03 壁(Aft) と デッキ DL03 を結ぶ(1501)
bracketPram_dl03 = part.CreateBracketParam()
bracketPram_dl03.DefinitionType=1
bracketPram_dl03.BracketName="BKT.DL03.Aft_to_DeckD"
bracketPram_dl03.MaterialName="SS400"
bracketPram_dl03.BaseElement=profile19[0]  # HK.Casing.Wall.Aft.DL03.CDP
bracketPram_dl03.UseSideSheetForPlane=False
bracketPram_dl03.Mold="+"
bracketPram_dl03.Thickness="8"
bracketPram_dl03.BracketType=1501
bracketPram_dl03.Scallop1Type=1801
bracketPram_dl03.Scallop1Params=["0"]
bracketPram_dl03.Scallop2Type=0
bracketPram_dl03.Surfaces1=[profile19[0]+",FL"]
bracketPram_dl03.RevSf1=False
bracketPram_dl03.Surfaces2=[profile18[0]+",FL"]  # HK.Casing.Deck.D.DL03P
bracketPram_dl03.RevSf2=False
bracketPram_dl03.RevSf3=False
bracketPram_dl03.Sf1DimensionType=1531
bracketPram_dl03.Sf1DimensonParams=["220","15"]
bracketPram_dl03.Sf2DimensionType=1531
bracketPram_dl03.Sf2DimensonParams=["220","15"]
bkt_dl03 = part.CreateBracket(bracketPram_dl03,False)
part.BlankElement(bkt_dl03,True)
part.SetElementColor(bkt_dl03,"0","255","255","0.19999998807907104")