...
bracketPram1.BracketName="HK.Brk.Wall.Fore.DL05.Deck.CDP"
...
bracketPram2.BracketName="HK.Brk.Wall.Aft.DL05.Deck.CDP"
...
bracketPram3.BracketName="HK.Brk.Wall.Fore.DL01.Deck.CDP"
...
bracketPram4.BracketName="HK.Brk.Wall.Aft.DL01.Deck.CDP"
bracketPram4.MaterialName="SS400"
bracketPram4.BaseElement=profile75[0]
...
bracketPram4.Surfaces1=[profile75[0]+",FL"]
bracketPram4.RevSf1=False
bracketPram4.Surfaces2=[profile23[0]+",FL"]
...
bracketPram5.BracketName="HK.Brk.Wall.Fore.DL03.Deck.CDP"
...
bracketPram6.BracketName="HK.Brk.Wall.Aft.DL03.Deck.CDP"
...
bracketPram7.BracketName="HK.Brk.Wall.Fore.DL04.Deck.CDP"
...
bracketPram8.BracketName="HK.Brk.Wall.Aft.DL04.Deck.CDP"
...
bracketPram9.BracketName="HK.Brk.Wall.Side.FR10.Deck.CDP"
...
bracketPram10.BracketName="HK.Brk.Wall.Side.FR12.Deck.CDP"
...
bracketPram11.BracketName="HK.Brk.Wall.Side.FR14.Deck.CDP"
bracketPram11.MaterialName="SS400"
bracketPram11.BaseElement=profile113[0]
...
bracketPram11.Surfaces2=[profile113[0]+",FL"]
...
bracketPram12.BracketName="HK.Brk.Wall.Side.FR07.Deck.CDP"
...
bracketPram13.BracketName="HK.Brk.Wall.Side.FR11.Deck.CDP"
bracketPram13.MaterialName="SS400"
bracketPram13.BaseElement=profile111[0]
...
bracketPram13.Surfaces2=[profile111[0]+",FL"]
...
bracketPram14.BracketName="HK.Brk.Wall.Side.FR15.Deck.CDP"
bracketPram14.MaterialName="SS400"
bracketPram14.BaseElement=profile3[0]
...
bracketPram14.Surfaces2=[profile3[0]+",FL"]
...
# --- Bracket追加（編集指示対応） ---
# 既存のブラケットは主に一部スティフナに対してのみ付与されていたため、
# 追加で「End1/End2 が定義されるスティフナ(ProfileType 1002/1003)」の端部に対して、
# 参考スクリプトで実績のある BracketType/フィールド構成（1501/1505）を踏襲して補完する。

# 1) Profile FL × Profile FL（BracketType=1501）: Deck.D 上の主要Profile端部接続（End要素があるもの）
bracketPram15 = part.CreateBracketParam()
bracketPram15.DefinitionType=1
bracketPram15.BracketName="HK.Brk.Wall.Fore.DL00.Deck.DP"
bracketPram15.MaterialName="SS400"
bracketPram15.BaseElement=profile94[0]
...
bracketPram15.Surfaces1=[profile94[0]+",FL"]
bracketPram15.RevSf1=False
bracketPram15.Surfaces2=[profile93[0]+",FL"]
...
bracketPram16.BracketName="HK.Brk.Wall.Aft.DL00.Deck.DP"
bracketPram16.MaterialName="SS400"
bracketPram16.BaseElement=profile121[0]
...
bracketPram16.Surfaces1=[profile121[0]+",FL"]
bracketPram16.RevSf1=False
bracketPram16.Surfaces2=[profile33[0]+",FL"]
...
# 2) Plate（PLS）× Profile（FL）（BracketType=1505）: Side系スティフナの端部を Deck.D(plate) に補完
bracketPram17 = part.CreateBracketParam()
bracketPram17.DefinitionType=1
bracketPram17.BracketName="HK.Brk.Wall.Side.FR08.Deck.CDP"
bracketPram17.MaterialName="SS400"
bracketPram17.BaseElement=profile12[0]
...
bracketPram17.Surfaces2=[profile12[0]+",FL"]
...
bracketPram18.BracketName="HK.Brk.Wall.Side.FR09.Deck.CDP"
...
bracketPram19.BracketName="HK.Brk.Wall.Side.FR13.Deck.CDP"
...
bracketPram20.BracketName="HK.Brk.Wall.Side.FR15.Deck.OAP"
bracketPram20.MaterialName="SS400"
bracketPram20.BaseElement=profile118[0]
...
# 修正点:
# BracketType=1505 の PLS 参照は、他の1505ブラケットと同様に「Sheet要素(extrude_sheet2)」を渡す必要がある。
# solid4(=Solid) を渡すとCOM側で型不一致となり例外になるため、Deck.Aのシート(extrude_sheet2)へ最小変更で修正。
bracketPram20.Surfaces1=["PLS","False","False","0","-0","-1",extrude_sheet2]
bracketPram20.RevSf1=False
bracketPram20.Surfaces2=[profile118[0]+",FL"]
...
bracketPram20.Sf1EndElements=["PLS","False","False","-0","-1","-0",profile49[0]]
