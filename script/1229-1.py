...
# --- Brackets added (Deck.DP series + DL00 decks, mirrored where applicable) ---
...
bracketPram11.BracketName="HK.Casing.Wall.Side.FR07.Deck.DP"
bracketPram11.MaterialName="SS400"
bracketPram11.BaseElement=profile16[0]
...
# FIX: solid2 boolean reference caused CreateBracket to hang/timeout; use deck sheet (PLS) instead (minimal change)
bracketPram11.Surfaces1=["PLS","False","False","0","-0","-1",extrude_sheet5]
bracketPram11.RevSf1=False
bracketPram11.Surfaces2=[profile16[0]+",FL"]
...
# FIX: solid2 boolean reference caused CreateBracket to hang/timeout; use deck sheet (PLS) instead (minimal change)
bracketPram12.Surfaces1=["PLS","False","False","0","-0","-1",extrude_sheet5]
...
bracketPram14.BracketName="HK.Casing.Wall.Side.FR10.Deck.DP"
bracketPram14.MaterialName="SS400"
bracketPram14.BaseElement=profile44[0]
...
# FIX: solid2 boolean reference caused CreateBracket to hang/timeout; use deck sheet (PLS) instead (minimal change)
bracketPram14.Surfaces1=["PLS","False","False","0","-0","-1",extrude_sheet5]
bracketPram14.RevSf1=False
bracketPram14.Surfaces2=[profile44[0]+",FL"]
...
# FIX: solid2 boolean reference caused CreateBracket to hang/timeout; use deck sheet (PLS) instead (minimal change)
bracketPram15.Surfaces1=["PLS","False","False","0","-0","-1",extrude_sheet5]
...
bracketPram16.BracketName="HK.Casing.Wall.Side.FR12.Deck.DP"
bracketPram16.MaterialName="SS400"
bracketPram16.BaseElement=profile52[0]
...
# FIX: solid2 boolean reference caused CreateBracket to hang/timeout; use deck sheet (PLS) instead (minimal change)
bracketPram16.Surfaces1=["PLS","False","False","0","-0","-1",extrude_sheet5]
bracketPram16.RevSf1=False
bracketPram16.Surfaces2=[profile52[0]+",FL"]
...
bracketPram17.BracketName="HK.Casing.Wall.Side.FR13.Deck.DP"
bracketPram17.MaterialName="SS400"
bracketPram17.BaseElement=profile43[0]
...
bracketPram17.Surfaces1=[profile43[0]+",FL"]
bracketPram17.RevSf1=False
bracketPram17.Surfaces2=[profile42[0]+",FL"]
...
bracketPram18.BracketName="HK.Casing.Wall.Side.FR14.Deck.DP"
bracketPram18.MaterialName="SS400"
bracketPram18.BaseElement=profile113[0]
...
# FIX: solid2 boolean reference caused CreateBracket to hang/timeout; use deck sheet (PLS) instead (minimal change)
bracketPram18.Surfaces1=["PLS","False","False","0","-0","-1",extrude_sheet5]
bracketPram18.RevSf1=False
bracketPram18.Surfaces2=[profile113[0]+",FL"]
...
bracketPram19.BracketName="HK.Casing.Wall.Side.FR15.Deck.DP"
...
# FIX: solid2 boolean reference caused CreateBracket to hang/timeout; use deck sheet (PLS) instead (minimal change)
bracketPram19.Surfaces1=["PLS","False","False","0","-0","-1",extrude_sheet5]
...
bracketPram20.BracketName="HK.Casing.Deck.D.FR09P"
bracketPram20.MaterialName="SS400"
bracketPram20.BaseElement=profile64[0]
...
bracketPram20.Surfaces2=[profile64[0]+",FL"]
...
bracketPram21.BracketName="HK.Casing.Deck.D.FR09P"
bracketPram21.MaterialName="SS400"
bracketPram21.BaseElement=mirror_copied66[0]
bracketPram21.UseSideSheetForPlane=False
bracketPram21.Mold="+"
bracketPram21.Thickness="8.9999999999999982"
bracketPram21.BracketType=1501
bracketPram21.Scallop1Type=1801
bracketPram21.Scallop1Params=["50"]
bracketPram21.Scallop2Type=0
bracketPram21.Surfaces1=[mirror_copied5[0]+",WF"]
bracketPram21.RevSf1=False
bracketPram21.Surfaces2=[mirror_copied66[0]+",FL"]
bracketPram21.RevSf2=False
bracketPram21.RevSf3=False
bracketPram21.FlangeType=262
bracketPram21.FlangeParams=["75","30","29.999999999999996","30","50","1"]
bracketPram21.RevFlange=False
bracketPram21.Sf1DimensionType=1541
bracketPram21.Sf1DimensonParams=["0","80"]
bracketPram21.Sf1EndElements=[mirror_copied108[0]+",FR"]
bracketPram21.Sf2DimensionType=1531
bracketPram21.Sf2DimensonParams=["300","15"]
...
bracketPram23.BaseElement=mirror_copied141[0]
...
bracketPram23.Surfaces1=[mirror_copied5[0]+",WF"]
bracketPram23.RevSf1=False
bracketPram23.Surfaces2=[mirror_copied141[0]+",FL"]
...
bracketPram23.Sf1EndElements=[mirror_copied108[0]+",FR"]
...
# DL00 Deck A/B/C/D DP (simple FLxFL where available)
bracketPram24 = part.CreateBracketParam()
bracketPram24.DefinitionType=1
bracketPram24.BracketName="HK.Casing.Deck.A.DL00.DP"
bracketPram24.MaterialName="SS400"
bracketPram24.BaseElement=profile50[0]
...
bracketPram24.Surfaces1=[profile50[0]+",FL"]
bracketPram24.RevSf1=False
bracketPram24.Surfaces2=[profile48[0]+",FL"]
...
bracketPram25.BracketName="HK.Casing.Deck.B.DL00.DP"
bracketPram25.MaterialName="SS400"
bracketPram25.BaseElement=profile85[0]
...
bracketPram25.Surfaces1=[profile85[0]+",FL"]
bracketPram25.RevSf1=False
bracketPram25.Surfaces2=[profile84[0]+",FL"]
...
bracketPram26.BracketName="HK.Casing.Deck.C.DL00.DP"
bracketPram26.MaterialName="SS400"
bracketPram26.BaseElement=profile74[0]
...
bracketPram26.Surfaces1=[profile74[0]+",FL"]
bracketPram26.RevSf1=False
bracketPram26.Surfaces2=[profile73[0]+",FL"]
...
bracketPram27.BracketName="HK.Casing.Deck.D.DL00.DP"
bracketPram27.MaterialName="SS400"
bracketPram27.BaseElement=profile93[0]
...
bracketPram27.Surfaces1=[profile93[0]+",FL"]
bracketPram27.RevSf1=False
bracketPram27.Surfaces2=[profile94[0]+",FL"]
...
# Mirror copies for symmetric brackets where possible
mirror_brackets1 = part.MirrorCopy([bracket11, bracket12, bracket13, bracket14, bracket15, bracket16, bracket17, bracket18, bracket19, bracket20, bracket24, bracket25, bracket26, bracket27], "PL,Y", "")