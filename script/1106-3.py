...
# =========================
# 追加: ブラケット作成(6点)
# 1) HK.Casing.Wall.Fore.DL01.Deck.DP
bracketPram_b1 = part.CreateBracketParam()
bracketPram_b1.DefinitionType=1
bracketPram_b1.BracketName="HK.Casing.Wall.Fore.DL01.Deck.DP"
bracketPram_b1.MaterialName="SS400"
bracketPram_b1.BaseElement=profile9[0]  # HK.Casing.Wall.Fore.DL01.CDP
bracketPram_b1.UseSideSheetForPlane=False
bracketPram_b1.Mold="+"
bracketPram_b1.Thickness="8"
bracketPram_b1.BracketType=1501
bracketPram_b1.Scallop1Type=1801
bracketPram_b1.Scallop1Params=["0"]
bracketPram_b1.Scallop2Type=0
bracketPram_b1.Surfaces1=[profile9[0]+",FL"]       # 基準: Fore.DL01 のフランジ面
bracketPram_b1.RevSf1=False
bracketPram_b1.Surfaces2=[profile6[1]+",FL"]       # 相手: Deck.D.DL02P のフランジ面(1201のフランジ部と想定)
bracketPram_b1.RevSf2=False
bracketPram_b1.RevSf3=False
bracketPram_b1.Sf1DimensionType=1531
bracketPram_b1.Sf1DimensonParams=["250","15"]
bracketPram_b1.Sf2DimensionType=1531
bracketPram_b1.Sf2DimensonParams=["250","15"]
bracket_b1 = part.CreateBracket(bracketPram_b1,False)
part.BlankElement(bracket_b1,True)
part.SetElementColor(bracket_b1,"0","255","255","0.2")

# 2) HK.Casing.Wall.Fore.DL02.Deck.DP
bracketPram_b2 = part.CreateBracketParam()
bracketPram_b2.DefinitionType=1
bracketPram_b2.BracketName="HK.Casing.Wall.Fore.DL02.Deck.DP"
bracketPram_b2.MaterialName="SS400"
bracketPram_b2.BaseElement=profile13[0]  # HK.Casing.Wall.Fore.DL02.CDP
bracketPram_b2.UseSideSheetForPlane=False
bracketPram_b2.Mold="+"
bracketPram_b2.Thickness="8"
bracketPram_b2.BracketType=1501
bracketPram_b2.Scallop1Type=1801
bracketPram_b2.Scallop1Params=["0"]
bracketPram_b2.Scallop2Type=0
bracketPram_b2.Surfaces1=[profile13[0]]           # Fore.DL02 の面
bracketPram_b2.RevSf1=False
bracketPram_b2.Surfaces2=[profile4[0]]            # FR08 の面
bracketPram_b2.RevSf2=False
bracketPram_b2.RevSf3=False
bracketPram_b2.Sf1DimensionType=1531
bracketPram_b2.Sf1DimensonParams=["250","15"]
bracketPram_b2.Sf2DimensionType=1531
bracketPram_b2.Sf2DimensonParams=["250","15"]
bracket_b2 = part.CreateBracket(bracketPram_b2,False)
part.BlankElement(bracket_b2,True)
part.SetElementColor(bracket_b2,"0","255","255","0.2")

# 3) HK.Casing.Deck.D.FR13P
bracketPram_b3 = part.CreateBracketParam()
bracketPram_b3.DefinitionType=1
bracketPram_b3.BracketName="HK.Casing.Deck.D.FR13P"
bracketPram_b3.MaterialName="SS400"
bracketPram_b3.BaseElement=profile14[0]  # HK.Casing.Deck.D.FR13P
bracketPram_b3.UseSideSheetForPlane=False
bracketPram_b3.Mold="+"
bracketPram_b3.Thickness="8"
bracketPram_b3.BracketType=1501
bracketPram_b3.Scallop1Type=1801
bracketPram_b3.Scallop1Params=["0"]
bracketPram_b3.Scallop2Type=0
bracketPram_b3.Surfaces1=[profile4[0]+",WF"]      # FR08 のウェブ面
bracketPram_b3.RevSf1=False
bracketPram_b3.Surfaces2=[profile14[0]+",FL"]     # FR13P のフランジ面
bracketPram_b3.RevSf2=False
bracketPram_b3.RevSf3=False
bracketPram_b3.Sf1DimensionType=1531
bracketPram_b3.Sf1DimensonParams=["250","15"]
bracketPram_b3.Sf2DimensionType=1531
bracketPram_b3.Sf2DimensonParams=["250","15"]
bracket_b3 = part.CreateBracket(bracketPram_b3,False)
part.BlankElement(bracket_b3,True)
part.SetElementColor(bracket_b3,"0","255","255","0.2")

# 4) HK.Casing.Wall.Side.FR10.Deck.DP
bracketPram_b4 = part.CreateBracketParam()
bracketPram_b4.DefinitionType=1
bracketPram_b4.BracketName="HK.Casing.Wall.Side.FR10.Deck.DP"
bracketPram_b4.MaterialName="SS400"
bracketPram_b4.BaseElement=profile16[0]  # HK.Casing.Wall.Side.FR10.CDP
bracketPram_b4.UseSideSheetForPlane=False
bracketPram_b4.Mold="+"
bracketPram_b4.Thickness="8"
bracketPram_b4.BracketType=1505
bracketPram_b4.Scallop1Type=1801
bracketPram_b4.Scallop1Params=["0"]
bracketPram_b4.Scallop2Type=0
bracketPram_b4.Surfaces1=[solid1]                 # solid1 の面
bracketPram_b4.RevSf1=False
bracketPram_b4.Surfaces2=[profile16[0]+",FL"]     # FR10 のフランジ面
bracketPram_b4.RevSf2=False
bracketPram_b4.RevSf3=False
bracketPram_b4.Sf1DimensionType=1531
bracketPram_b4.Sf1DimensonParams=["250","15"]
bracketPram_b4.Sf2DimensionType=1531
bracketPram_b4.Sf2DimensonParams=["250","15"]
bracket_b4 = part.CreateBracket(bracketPram_b4,False)
part.BlankElement(bracket_b4,True)
part.SetElementColor(bracket_b4,"0","255","255","0.2")

# 5) HK.Casing.Wall.Aft.DL02.Deck.DP
bracketPram_b5 = part.CreateBracketParam()
bracketPram_b5.DefinitionType=1
bracketPram_b5.BracketName="HK.Casing.Wall.Aft.DL02.Deck.DP"
bracketPram_b5.MaterialName="SS400"
bracketPram_b5.BaseElement=profile10[0]  # HK.Casing.Wall.Aft.DL02.CDP
bracketPram_b5.UseSideSheetForPlane=False
bracketPram_b5.Mold="+"
bracketPram_b5.Thickness="8"
bracketPram_b5.BracketType=1501
bracketPram_b5.Scallop1Type=1801
bracketPram_b5.Scallop1Params=["0"]
bracketPram_b5.Scallop2Type=0
bracketPram_b5.Surfaces1=[profile10[0]]           # Aft.DL02 の面
bracketPram_b5.RevSf1=False
bracketPram_b5.Surfaces2=[profile4[0]]            # FR08 の面
bracketPram_b5.RevSf2=False
bracketPram_b5.RevSf3=False
bracketPram_b5.Sf1DimensionType=1531
bracketPram_b5.Sf1DimensonParams=["250","15"]
bracketPram_b5.Sf2DimensionType=1531
bracketPram_b5.Sf2DimensonParams=["250","15"]
bracket_b5 = part.CreateBracket(bracketPram_b5,False)
part.BlankElement(bracket_b5,True)
part.SetElementColor(bracket_b5,"0","255","255","0.2")

# 6) HK.Casing.Wall.Aft.DL04.Deck.DP
bracketPram_b6 = part.CreateBracketParam()
bracketPram_b6.DefinitionType=1
bracketPram_b6.BracketName="HK.Casing.Wall.Aft.DL04.Deck.DP"
bracketPram_b6.MaterialName="SS400"
bracketPram_b6.BaseElement=profile3[0]  # HK.Casing.Wall.Aft.DL04.CDP
bracketPram_b6.UseSideSheetForPlane=False
bracketPram_b6.Mold="+"
bracketPram_b6.Thickness="8"
bracketPram_b6.BracketType=1501
bracketPram_b6.Scallop1Type=1801
bracketPram_b6.Scallop1Params=["0"]
bracketPram_b6.Scallop2Type=0
bracketPram_b6.Surfaces1=[profile3[0]+",FL"]      # Aft.DL04 のフランジ面
bracketPram_b6.RevSf1=False
bracketPram_b6.Surfaces2=[profile24[0]+",FL"]     # Fore.DL03 のフランジ面
bracketPram_b6.RevSf2=False
bracketPram_b6.RevSf3=False
bracketPram_b6.Sf1DimensionType=1531
bracketPram_b6.Sf1DimensonParams=["250","15"]
bracketPram_b6.Sf2DimensionType=1531
bracketPram_b6.Sf2DimensonParams=["250","15"]
bracket_b6 = part.CreateBracket(bracketPram_b6,False)
part.BlankElement(bracket_b6,True)
part.SetElementColor(bracket_b6,"0","255","255","0.2")