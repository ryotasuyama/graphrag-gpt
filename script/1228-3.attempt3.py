...
ProfilePram110.BasePlane="PL,O,"+var_elm15+","+"Y"
...
# --- Bracket追加（参考スクリプトの既存実績パターンを踏襲） ---
# 追加方針:
#   - Plate(PLS)×Profile(FL) : BracketType=1505（既存実績）
#   - Profile(FL)×Profile(FL): BracketType=1501（既存実績）
#   - CreateBracket(..., False) を厳守
#   - BlankElement(..., True) をブラケットに対して呼ばない

# Deck.C（solid1=HK.Casing.Deck.C）×Side FR08/FR11/FR14/FR12/FR10/FR07（端部に対して）
bracketPram1 = part.CreateBracketParam()
bracketPram1.DefinitionType=1
bracketPram1.BracketName="HK.Auto.Bracket.DeckC.Side.FR08"
...
bracketPram2.BracketName="HK.Auto.Bracket.DeckC.Side.FR11"
...
mirror_copied_brkt2 = part.MirrorCopy([bracket2],"PL,Y","")
part.SetElementColor(mirror_copied_brkt2[0],"0","255","255","0.19999998807907104")

bracketPram3 = part.CreateBracketParam()
bracketPram3.DefinitionType=1
bracketPram3.BracketName="HK.Auto.Bracket.DeckC.Side.FR14"
bracketPram3.MaterialName="SS400"
bracketPram3.BaseElement=profile21[0]
...
bracketPram3.Surfaces1=["PLS","False","False","0","-0","-1",solid1]
bracketPram3.RevSf1=False
bracketPram3.Surfaces2=[profile21[0]+",FL"]
bracketPram3.RevSf2=False
bracketPram3.RevSf3=False
bracketPram3.Sf1DimensionType=1541
bracketPram3.Sf1DimensonParams=["0","100"]
bracketPram3.Sf1EndElements=["PLS","False","False","-0","-1","-0",profile8[0]]
...
mirror_copied_brkt3 = part.MirrorCopy([bracket3],"PL,Y","")
part.SetElementColor(mirror_copied_brkt3[0],"0","255","255","0.19999998807907104")

bracketPram4 = part.CreateBracketParam()
bracketPram4.DefinitionType=1
bracketPram4.BracketName="HK.Auto.Bracket.DeckC.Side.FR12"
bracketPram4.MaterialName="SS400"
bracketPram4.BaseElement=profile79[0]
...
mirror_copied_brkt4 = part.MirrorCopy([bracket4],"PL,Y","")
part.SetElementColor(mirror_copied_brkt4[0],"0","255","255","0.19999998807907104")

bracketPram5 = part.CreateBracketParam()
bracketPram5.DefinitionType=1
bracketPram5.BracketName="HK.Auto.Bracket.DeckC.Side.FR10"
bracketPram5.MaterialName="SS400"
bracketPram5.BaseElement=profile92[0]
...
mirror_copied_brkt5 = part.MirrorCopy([bracket5],"PL,Y","")
part.SetElementColor(mirror_copied_brkt5[0],"0","255","255","0.19999998807907104")

bracketPram6 = part.CreateBracketParam()
bracketPram6.DefinitionType=1
bracketPram6.BracketName="HK.Auto.Bracket.DeckC.Side.FR07"
bracketPram6.MaterialName="SS400"
bracketPram6.BaseElement=profile51[0]
...
bracketPram6.Surfaces1=["PLS","False","False","0","-0","-1",solid1]
bracketPram6.RevSf1=False
bracketPram6.Surfaces2=[profile51[0]+",FL"]
bracketPram6.RevSf2=False
bracketPram6.RevSf3=False
bracketPram6.Sf1DimensionType=1541
bracketPram6.Sf1DimensonParams=["0","100"]
bracketPram6.Sf1EndElements=["PLS","False","False","-0","-1","-0",profile8[0]]
...
mirror_copied_brkt6 = part.MirrorCopy([bracket6],"PL,Y","")
part.SetElementColor(mirror_copied_brkt6[0],"0","255","255","0.19999998807907104")

# Deck.D（solid2=HK.Casing.Deck.D）×Side FR08/FR10/FR11/FR14/FR07（参考スクリプトの1505パターン）
bracketPram7 = part.CreateBracketParam()
bracketPram7.DefinitionType=1
bracketPram7.BracketName="HK.Auto.Bracket.DeckD.Side.FR08"
...
mirror_copied_brkt7 = part.MirrorCopy([bracket7],"PL,Y","")
part.SetElementColor(mirror_copied_brkt7[0],"0","255","255","0.19999998807907104")

bracketPram8 = part.CreateBracketParam()
bracketPram8.DefinitionType=1
bracketPram8.BracketName="HK.Auto.Bracket.DeckD.Side.FR10"
...
mirror_copied_brkt8 = part.MirrorCopy([bracket8],"PL,Y","")
part.SetElementColor(mirror_copied_brkt8[0],"0","255","255","0.19999998807907104")

bracketPram9 = part.CreateBracketParam()
bracketPram9.DefinitionType=1
bracketPram9.BracketName="HK.Auto.Bracket.DeckD.Side.FR11"
...
mirror_copied_brkt9 = part.MirrorCopy([bracket9],"PL,Y","")
part.SetElementColor(mirror_copied_brkt9[0],"0","255","255","0.19999998807907104")

bracketPram10 = part.CreateBracketParam()
bracketPram10.DefinitionType=1
bracketPram10.BracketName="HK.Auto.Bracket.DeckD.Side.FR14"
bracketPram10.MaterialName="SS400"
bracketPram10.BaseElement=profile113[0]
...
bracketPram10.Surfaces2=[profile113[0]+",FL"]
...
mirror_copied_brkt10 = part.MirrorCopy([bracket10],"PL,Y","")
part.SetElementColor(mirror_copied_brkt10[0],"0","255","255","0.19999998807907104")

bracketPram11 = part.CreateBracketParam()
bracketPram11.DefinitionType=1
bracketPram11.BracketName="HK.Auto.Bracket.DeckD.Side.FR07"
...
mirror_copied_brkt11 = part.MirrorCopy([bracket11],"PL,Y","")
part.SetElementColor(mirror_copied_brkt11[0],"0","255","255","0.19999998807907104")

# Deck.A（solid4=HK.Casing.Deck.A）×Side FR07/FR08/FR10/FR11/FR12/FR14（参考スクリプトの1505パターン）
bracketPram12 = part.CreateBracketParam()
bracketPram12.DefinitionType=1
bracketPram12.BracketName="HK.Auto.Bracket.DeckA.Side.FR14"
bracketPram12.MaterialName="SS400"
bracketPram12.BaseElement=profile58[0]
...
bracketPram12.Surfaces1=["PLS","False","False","0","-0","-1",solid4]
bracketPram12.RevSf1=False
bracketPram12.Surfaces2=[profile58[0]+",FL"]
...
bracketPram12.Sf1EndElements=["PLS","False","False","-0","-1","-0",profile47[0]]
...
mirror_copied_brkt12 = part.MirrorCopy([bracket12],"PL,Y","")
part.SetElementColor(mirror_copied_brkt12[0],"0","255","255","0.19999998807907104")

bracketPram13 = part.CreateBracketParam()
bracketPram13.DefinitionType=1
bracketPram13.BracketName="HK.Auto.Bracket.DeckA.Side.FR10"
bracketPram13.MaterialName="SS400"
bracketPram13.BaseElement=profile82[0]
...
bracketPram13.Surfaces1=["PLS","False","False","0","-0","-1",solid4]
bracketPram13.RevSf1=False
bracketPram13.Surfaces2=[profile82[0]+",FL"]
...
# --- FIX: Sf1EndElements を誤参照(profile47はDeckA.DL05PでFR10位置に適合しない可能性があるため、FR10側の端部要素として確実に存在する profile58[0] に変更 ---
bracketPram13.Sf1EndElements=["PLS","False","False","-0","-1","-0",profile58[0]]
...
mirror_copied_brkt13 = part.MirrorCopy([bracket13],"PL,Y","")
part.SetElementColor(mirror_copied_brkt13[0],"0","255","255","0.19999998807907104")

bracketPram14 = part.CreateBracketParam()
bracketPram14.DefinitionType=1
bracketPram14.BracketName="HK.Auto.Bracket.DeckA.Side.FR08"
bracketPram14.MaterialName="SS400"
bracketPram14.BaseElement=profile55[0]
...
bracketPram14.Surfaces2=[profile55[0]+",FL"]
...
bracketPram14.Sf1EndElements=["PLS","False","False","-0","-1","-0",profile47[0]]
...
mirror_copied_brkt14 = part.MirrorCopy([bracket14],"PL,Y","")
part.SetElementColor(mirror_copied_brkt14[0],"0","255","255","0.19999998807907104")

bracketPram15 = part.CreateBracketParam()
bracketPram15.DefinitionType=1
bracketPram15.BracketName="HK.Auto.Bracket.DeckA.Side.FR12"
bracketPram15.MaterialName="SS400"
bracketPram15.BaseElement=profile24[0]
...
bracketPram15.Surfaces1=["PLS","False","False","0","-0","-1",solid4]
bracketPram15.RevSf1=False
bracketPram15.Surfaces2=[profile24[0]+",FL"]
...
bracketPram15.Sf1EndElements=["PLS","False","False","-0","-1","-0",profile47[0]]
...
mirror_copied_brkt15 = part.MirrorCopy([bracket15],"PL,Y","")
part.SetElementColor(mirror_copied_brkt15[0],"0","255","255","0.19999998807907104")

bracketPram16 = part.CreateBracketParam()
bracketPram16.DefinitionType=1
bracketPram16.BracketName="HK.Auto.Bracket.DeckA.Side.FR07"
bracketPram16.MaterialName="SS400"
bracketPram16.BaseElement=profile34[0]
...
bracketPram16.Surfaces1=["PLS","False","False","0","-0","-1",solid4]
bracketPram16.RevSf1=False
bracketPram16.Surfaces2=[profile34[0]+",FL"]
...
bracketPram16.Sf1EndElements=["PLS","False","False","-0","-1","-0",profile47[0]]
...
mirror_copied_brkt16 = part.MirrorCopy([bracket16],"PL,Y","")
part.SetElementColor(mirror_copied_brkt16[0],"0","255","255","0.19999998807907104")