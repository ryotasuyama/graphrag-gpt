...
skt_ln2 = part.CreateSketchLine(skt_pl1,"","作図","-50000,15300","18500,14933.333333333334",False)
...
ProfilePram81.BasePlane="PL,O,"+var_elm8+","+"X"
ProfilePram81.AddAttachSurfaces(extrude_sheet6)
ProfilePram81.ProfileName="HK.Casing.Wall.Side.FR07.ABP"
...
ProfilePram81.AddEnd1Elements(extrude_sheet1)
ProfilePram81.End1Type=1102
ProfilePram81.End1TypeParams=["25","29.999999999999996","0","0"]
ProfilePram81.AddEnd2Elements(extrude_sheet2)
...
# Bracket 1: Plate (Deck C solid1) × Longitudinal profile15 (Casing.Deck.C.DL04P)
bracketPram1 = part.CreateBracketParam()
bracketPram1.DefinitionType = 1
bracketPram1.BracketName = "HK.Casing.Deck.C.DL04P.BKT"
bracketPram1.MaterialName = "SS400"
bracketPram1.BaseElement = profile15[0]
...
# Bracket 3: Plate (Deck B solid3) × Longitudinal profile30 (Casing.Deck.B.DL04P)
bracketPram3 = part.CreateBracketParam()
bracketPram3.DefinitionType = 1
bracketPram3.BracketName = "HK.Casing.Deck.B.DL04P.BKT"
bracketPram3.MaterialName = "SS400"
bracketPram3.BaseElement = profile30[0]
...
# Bracket 4: Profile × Profile between profile22 (Deck.D.FR09C) and profile18 (Deck.D.DL02P)
bracketPram4 = part.CreateBracketParam()
bracketPram4.DefinitionType = 1
bracketPram4.BracketName = "HK.Casing.Deck.D.FR09C-DL02P.BKT"
bracketPram4.MaterialName = "SS400"
bracketPram4.BaseElement = profile22[0]
...
bracketPram4.Surfaces1 = [profile22[0] + ",FL"]
bracketPram4.RevSf1 = False
bracketPram4.Surfaces2 = [profile18[0] + ",FL"]
