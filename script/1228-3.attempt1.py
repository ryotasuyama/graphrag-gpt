...
# --- FIX: end element for Sf1 was invalid for this location; align with other DeckA.Side brackets (use profile47[0]) ---
bracketPram13.Sf1EndElements=["PLS","False","False","-0","-1","-0",profile47[0]]
