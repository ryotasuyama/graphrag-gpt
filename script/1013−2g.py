...
extrude10 = part.CreateLinearSweep(solid4 := part.CreateSolid("HK.Casing.Wall.Side.CDP","","SS400"),"*",extrudePram16,False)
...
separated_bodies16 = part.BodyDivideByCurves("Separe body by curves39",profile27 := part.CreateProfile(
    (lambda p: (p.DefinitionType:=1,
                setattr(p,"BasePlane","PL,O,"+var_elm5+","+"Y"),
                p.AddAttachSurfaces(extrude_sheet3),
                setattr(p,"ProfileName","HK.Casing.Wall.Aft.DL01.CDP"),
                setattr(p,"MaterialName","SS400"),
                setattr(p,"ProfileType",1002),
                setattr(p,"ProfileParams",["125","75","7","10","5"]),
                setattr(p,"Mold","+"),
                setattr(p,"ReverseDir",False),
                setattr(p,"ReverseAngle",True),
                setattr(p,"CalcSnipOnlyAttachLines",False),
                setattr(p,"AttachDirMethod",0),
                setattr(p,"CCWDefAngle",False),
                p.AddEnd1Elements(
                    part.CreateProfile(
                        (lambda pp: (pp.DefinitionType:=1,
                                     setattr(pp,"BasePlane","PL,O,"+var_elm5+","+"Y"),
                                     pp.AddAttachSurfaces(extrude_sheet4),
                                     setattr(pp,"ProfileName","HK.Casing.Deck.D.DL01.AP"),
                                     setattr(pp,"MaterialName","SS400"),
                                     setattr(pp,"ProfileType",1002),
                                     setattr(pp,"ProfileParams",["125","75","7","10","5"]),
                                     setattr(pp,"Mold","+"),
                                     setattr(pp,"ReverseDir",True),
                                     setattr(pp,"ReverseAngle",True),
                                     setattr(pp,"CalcSnipOnlyAttachLines",False),
                                     setattr(pp,"AttachDirMethod",0),
                                     setattr(pp,"CCWDefAngle",False),
                                     pp.AddEnd1Elements(extrude_sheet3),
                                     setattr(pp,"End1Type",1102),
                                     setattr(pp,"End1TypeParams",["25","29.999999999999996","0","0"]),
                                     pp.AddEnd2Elements(profile22[0]),
                                     setattr(pp,"End2Type",1102),
                                     setattr(pp,"End2TypeParams",["25","29.999999999999996","0","0"]),
                                     setattr(pp,"End1ScallopType",1120),
                                     setattr(pp,"End1ScallopTypeParams",["50"]),
                                     setattr(pp,"End2ScallopType",1120),
                                     setattr(pp,"End2ScallopTypeParams",["50"]),
                                     pp))[0]
                ),
                setattr(p,"End1Type",1102),
                setattr(p,"End1TypeParams",["25","29.999999999999996","0","0"]),
                p.AddEnd2Elements(extrude_sheet1),
                setattr(p,"End2Type",1102),
                setattr(p,"End2TypeParams",["25","29.999999999999996","0","0"]),
                setattr(p,"End1ScallopType",1120),
                setattr(p,"End1ScallopTypeParams",["50"]),
                setattr(p,"End2ScallopType",1120),
                setattr(p,"End2ScallopTypeParams",["50"]),
                p))[0]
    )(part.CreateProfileParam())
,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies16[0],"255","0","0","0.19999998807907104")
separated_bodies18 = part.BodyDivideByCurves("Separe body by curves55",profile10[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies18[0],"148","0","211","0.38999998569488525")
...
separated_bodies12 = part.BodyDivideByCurves("Separe body by curves44",profile28 := part.CreateProfile(
    (lambda p: (p.DefinitionType:=1,
                setattr(p,"BasePlane","PL,O,"+var_elm2+","+"Y"),
                p.AddAttachSurfaces(extrude_sheet2),
                setattr(p,"ProfileName","HK.Casing.Wall.Fore.DL04.CDP"),
                setattr(p,"MaterialName","SS400"),
                setattr(p,"ProfileType",1002),
                setattr(p,"ProfileParams",["125","75","7","10","5"]),
                setattr(p,"Mold","+"),
                setattr(p,"ReverseDir",True),
                setattr(p,"ReverseAngle",True),
                setattr(p,"CalcSnipOnlyAttachLines",False),
                setattr(p,"AttachDirMethod",0),
                setattr(p,"CCWDefAngle",False),
                p.AddEnd1Elements(profile2[0]),
                setattr(p,"End1Type",1102),
                setattr(p,"End1TypeParams",["25","29.999999999999996","0","0"]),
                p.AddEnd2Elements(extrude_sheet1),
                setattr(p,"End2Type",1102),
...
separated_bodies14 = part.BodyDivideByCurves("Separe body by curves36",profile24[0],[skt_pl3],False,"0","","",False)
