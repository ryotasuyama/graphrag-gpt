...
# 修正点:
# Surfaces1 / Sf1EndElements の "PLS" 参照先が solid2(Deck.D) になっており、
# 本ブラケット名(OAP)と整合する Deck.A(=solid4) 側の面参照へ最小変更で合わせる。
bracketPram20.Surfaces1=["PLS","False","False","0","-0","-1",solid4]
