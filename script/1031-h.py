...
# ========= 追加：ブラケット（台形板）を多数作成（1501/1505） =========
# 1) FR13：側板プロファイル(profile15[0]) - デッキ側プロファイル(profile14[0]) を接続（1501）
brkP1 = part.CreateBracketParam()
brkP1.DefinitionType=1
brkP1.BracketName="BKT.FR13.Side2Deck.1501"
brkP1.MaterialName="SS400"
brkP1.BaseElement=profile15[0]
brkP1.UseSideSheetForPlane=False
brkP1.Mold="+"
brkP1.Thickness="8"
brkP1.BracketType=1501
brkP1.Scallop1Type=1801
brkP1.Scallop1Params=["0"]
brkP1.Scallop2Type=0
brkP1.Surfaces1=[profile15[0]+",FL"]
brkP1.RevSf1=False
brkP1.Surfaces2=[profile14[0]+",FL"]
brkP1.RevSf2=False
brkP1.RevSf3=False
brkP1.Sf1DimensionType=1531
brkP1.Sf1DimensonParams=["250","15"]
brkP1.Sf2DimensionType=1531
brkP1.Sf2DimensonParams=["250","15"]
bkt1 = part.CreateBracket(brkP1,False)
part.BlankElement(bkt1,True)
part.SetElementColor(bkt1,"0","255","255","0.2")

# 2) FR09：側板プロファイル(profile23[0]) - デッキ側プロファイル(profile21[0]) を接続（1501）
brkP2 = part.CreateBracketParam()
brkP2.DefinitionType=1
brkP2.BracketName="BKT.FR09.Side2Deck.1501"
brkP2.MaterialName="SS400"
brkP2.BaseElement=profile23[0]
brkP2.UseSideSheetForPlane=False
brkP2.Mold="+"
brkP2.Thickness="8"
brkP2.BracketType=1501
brkP2.Scallop1Type=1801
brkP2.Scallop1Params=["0"]
brkP2.Scallop2Type=0
brkP2.Surfaces1=[profile23[0]+",FL"]
brkP2.RevSf1=False
brkP2.Surfaces2=[profile21[0]+",FL"]
brkP2.RevSf2=False
brkP2.RevSf3=False
brkP2.Sf1DimensionType=1531
brkP2.Sf1DimensonParams=["220","15"]
brkP2.Sf2DimensionType=1531
brkP2.Sf2DimensonParams=["220","15"]
bkt2 = part.CreateBracket(brkP2,False)
part.BlankElement(bkt2,True)
part.SetElementColor(bkt2,"0","255","255","0.2")

# 3) FR09：側板プロファイル(profile23[0]) - デッキ側プロファイル(profile22[0]) を接続（1505）
brkP3 = part.CreateBracketParam()
brkP3.DefinitionType=1
brkP3.BracketName="BKT.FR09.Side2Deck.1505"
brkP3.MaterialName="SS400"
brkP3.BaseElement=profile23[0]
brkP3.UseSideSheetForPlane=False
brkP3.Mold="+"
brkP3.Thickness="10"
brkP3.BracketType=1505
brkP3.Scallop1Type=1801
brkP3.Scallop1Params=["0"]
brkP3.Scallop2Type=0
brkP3.Surfaces1=[profile23[0]+",FL"]
brkP3.RevSf1=False
brkP3.Surfaces2=[profile22[0]+",FL"]
brkP3.RevSf2=False
brkP3.RevSf3=False
brkP3.Sf1DimensionType=1531
brkP3.Sf1DimensonParams=["260","18"]
brkP3.Sf2DimensionType=1531
brkP3.Sf2DimensonParams=["260","18"]
bkt3 = part.CreateBracket(brkP3,False)
part.BlankElement(bkt3,True)
part.SetElementColor(bkt3,"0","255","255","0.2")

# 4) DL02：壁(Aft)プロファイル(profile10[0]) - デッキDL02(profile6[0]) を接続（1501）
brkP4 = part.CreateBracketParam()
brkP4.DefinitionType=1
brkP4.BracketName="BKT.DL02.Aft2Deck.1501"
brkP4.MaterialName="SS400"
brkP4.BaseElement=profile10[0]
brkP4.UseSideSheetForPlane=False
brkP4.Mold="+"
brkP4.Thickness="8"
brkP4.BracketType=1501
brkP4.Scallop1Type=1801
brkP4.Scallop1Params=["0"]
brkP4.Scallop2Type=0
brkP4.Surfaces1=[profile10[0]+",FL"]
brkP4.RevSf1=False
brkP4.Surfaces2=[profile6[0]+",FL"]
brkP4.RevSf2=False
brkP4.RevSf3=False
brkP4.Sf1DimensionType=1531
brkP4.Sf1DimensonParams=["200","15"]
brkP4.Sf2DimensionType=1531
brkP4.Sf2DimensonParams=["200","15"]
bkt4 = part.CreateBracket(brkP4,False)
part.BlankElement(bkt4,True)
part.SetElementColor(bkt4,"0","255","255","0.2")

# 5) DL03：壁(Aft)プロファイル(profile19[0]) - デッキDL03(profile18[0]) を接続（1505）
brkP5 = part.CreateBracketParam()
brkP5.DefinitionType=1
brkP5.BracketName="BKT.DL03.Aft2Deck.1505"
brkP5.MaterialName="SS400"
brkP5.BaseElement=profile19[0]
brkP5.UseSideSheetForPlane=False
brkP5.Mold="+"
brkP5.Thickness="10"
brkP5.BracketType=1505
brkP5.Scallop1Type=1801
brkP5.Scallop1Params=["0"]
brkP5.Scallop2Type=0
brkP5.Surfaces1=[profile19[0]+",FL"]
brkP5.RevSf1=False
brkP5.Surfaces2=[profile18[0]+",FL"]
brkP5.RevSf2=False
brkP5.RevSf3=False
brkP5.Sf1DimensionType=1531
brkP5.Sf1DimensonParams=["240","15"]
brkP5.Sf2DimensionType=1531
brkP5.Sf2DimensonParams=["240","15"]
bkt5 = part.CreateBracket(brkP5,False)
part.BlankElement(bkt5,True)
part.SetElementColor(bkt5,"0","255","255","0.2")

# 6) DL04：壁(Aft)プロファイル(profile3[0]) - デッキDL04(profile2[0]) を接続（1501）
brkP6 = part.CreateBracketParam()
brkP6.DefinitionType=1
brkP6.BracketName="BKT.DL04.Aft2Deck.1501"
brkP6.MaterialName="SS400"
brkP6.BaseElement=profile3[0]
brkP6.UseSideSheetForPlane=False
brkP6.Mold="+"
brkP6.Thickness="8"
brkP6.BracketType=1501
brkP6.Scallop1Type=1801
brkP6.Scallop1Params=["0"]
brkP6.Scallop2Type=0
brkP6.Surfaces1=[profile3[0]+",FL"]
brkP6.RevSf1=False
brkP6.Surfaces2=[profile2[0]+",FL"]
brkP6.RevSf2=False
brkP6.RevSf3=False
brkP6.Sf1DimensionType=1531
brkP6.Sf1DimensonParams=["220","15"]
brkP6.Sf2DimensionType=1531
brkP6.Sf2DimensonParams=["220","15"]
bkt6 = part.CreateBracket(brkP6,False)
part.BlankElement(bkt6,True)
part.SetElementColor(bkt6,"0","255","255","0.2")

# 7) DL05：壁(Fore)プロファイル(profile11[0]) - デッキDL05(profile1[0]) を接続（1501）
brkP7 = part.CreateBracketParam()
brkP7.DefinitionType=1
brkP7.BracketName="BKT.DL05.Fore2Deck.1501"
brkP7.MaterialName="SS400"
brkP7.BaseElement=profile11[0]
brkP7.UseSideSheetForPlane=False
brkP7.Mold="+"
brkP7.Thickness="8"
brkP7.BracketType=1501
brkP7.Scallop1Type=1801
brkP7.Scallop1Params=["0"]
brkP7.Scallop2Type=0
brkP7.Surfaces1=[profile11[0]+",FL"]
brkP7.RevSf1=False
brkP7.Surfaces2=[profile1[0]+",FL"]
brkP7.RevSf2=False
brkP7.RevSf3=False
brkP7.Sf1DimensionType=1531
brkP7.Sf1DimensonParams=["220","15"]
brkP7.Sf2DimensionType=1531
brkP7.Sf2DimensonParams=["220","15"]
bkt7 = part.CreateBracket(brkP7,False)
part.BlankElement(bkt7,True)
part.SetElementColor(bkt7,"0","255","255","0.2")

# 8) FR10：側板プロファイル(profile16[0]) - デッキソリッド(solid2) を接続（1505、片側を板に接続）
brkP8 = part.CreateBracketParam()
brkP8.DefinitionType=1
brkP8.BracketName="BKT.FR10.Profile2DeckPlate.1505"
brkP8.MaterialName="SS400"
brkP8.BaseElement=profile16[0]
brkP8.UseSideSheetForPlane=False
brkP8.Mold="+"
brkP8.Thickness="10"
brkP8.BracketType=1505
brkP8.Scallop1Type=1801
brkP8.Scallop1Params=["0"]
brkP8.Scallop2Type=0
brkP8.Surfaces1=[profile16[0]+",FL"]
brkP8.RevSf1=False
# Solid（デッキ板）側は PLS 指定（サンプルに準拠）
brkP8.Surfaces2=["PLS","True","False","0","-0","1",solid2]
brkP8.RevSf2=False
brkP8.RevSf3=False
brkP8.Sf1DimensionType=1531
brkP8.Sf1DimensonParams=["240","18"]
brkP8.Sf2DimensionType=1531
brkP8.Sf2DimensonParams=["240","18"]
bkt8 = part.CreateBracket(brkP8,False)
part.BlankElement(bkt8,True)
part.SetElementColor(bkt8,"0","255","255","0.2")

# 9) FR12：側板プロファイル(profile17[0]) - 壁(Aft)ソリッド(solid3) を接続（1501）
brkP9 = part.CreateBracketParam()
brkP9.DefinitionType=1
brkP9.BracketName="BKT.FR12.Profile2WallPlate.1501"
brkP9.MaterialName="SS400"
brkP9.BaseElement=profile17[0]
brkP9.UseSideSheetForPlane=False
brkP9.Mold="+"
brkP9.Thickness="8"
brkP9.BracketType=1501
brkP9.Scallop1Type=1801
brkP9.Scallop1Params=["0"]
brkP9.Scallop2Type=0
brkP9.Surfaces1=[profile17[0]+",FL"]
brkP9.RevSf1=False
brkP9.Surfaces2=["PLS","True","False","0","-0","1",solid3]
brkP9.RevSf2=False
brkP9.RevSf3=False
brkP9.Sf1DimensionType=1531
brkP9.Sf1DimensonParams=["220","15"]
brkP9.Sf2DimensionType=1531
brkP9.Sf2DimensonParams=["220","15"]
bkt9 = part.CreateBracket(brkP9,False)
part.BlankElement(bkt9,True)
part.SetElementColor(bkt9,"0","255","255","0.2")

# 10) FR11：側板プロファイル(profile12[0]) - デッキソリッド(solid2) を接続（1501）
brkP10 = part.CreateBracketParam()
brkP10.DefinitionType=1
brkP10.BracketName="BKT.FR11.Profile2DeckPlate.1501"
brkP10.MaterialName="SS400"
brkP10.BaseElement=profile12[0]
brkP10.UseSideSheetForPlane=False
brkP10.Mold="+"
brkP10.Thickness="8"
brkP10.BracketType=1501
brkP10.Scallop1Type=1801
brkP10.Scallop1Params=["0"]
brkP10.Scallop2Type=0
brkP10.Surfaces1=[profile12[0]+",FL"]
brkP10.RevSf1=False
brkP10.Surfaces2=["PLS","True","False","0","-0","1",solid2]
brkP10.RevSf2=False
brkP10.RevSf3=False
brkP10.Sf1DimensionType=1531
brkP10.Sf1DimensonParams=["200","15"]
brkP10.Sf2DimensionType=1531
brkP10.Sf2DimensonParams=["200","15"]
bkt10 = part.CreateBracket(brkP10,False)
part.BlankElement(bkt10,True)
part.SetElementColor(bkt10,"0","255","255","0.2")
