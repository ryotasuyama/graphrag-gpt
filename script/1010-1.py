...
separated_bodies42 = part.BodyDivideByCurves("Separe body by curves53",profile6[1],[skt_pl3],False,"0","","",False)
...
separated_bodies46 = part.BodyDivideByCurves("Separe body by curves57",profile13[1],[skt_pl3],False,"0","","",False)
...
# -------------------------------
# 追加: ブラケット（台形板）多数配置 1501/1505
# 参照: buraketto.py の CreateBracketParam/CreateBracket 使用例
# -------------------------------

# FR13 壁側プロファイル と デッキFR13P を結ぶブラケット（1501）
bracketPramA = part.CreateBracketParam()
bracketPramA.DefinitionType=1
bracketPramA.BracketName="HK.Bkt.FR13.Side_to_DeckP"
bracketPramA.MaterialName="SS400"
bracketPramA.BaseElement=profile15[0]
bracketPramA.UseSideSheetForPlane=False
bracketPramA.Mold="+"
bracketPramA.Thickness="8"
bracketPramA.BracketType=1501
bracketPramA.Scallop1Type=1801
bracketPramA.Scallop1Params=["0"]
bracketPramA.Scallop2Type=0
bracketPramA.Surfaces1=[profile15[0]+",FL"]
bracketPramA.RevSf1=False
bracketPramA.Surfaces2=[profile14[0]+",FL"]
bracketPramA.RevSf2=False
bracketPramA.RevSf3=False
bracketPramA.Sf1DimensionType=1531
bracketPramA.Sf1DimensonParams=["250","15"]
bracketPramA.Sf2DimensionType=1531
bracketPramA.Sf2DimensonParams=["250","15"]
bktA = part.CreateBracket(bracketPramA,False)
part.BlankElement(bktA,True)
part.SetElementColor(bktA,"0","255","255","0.19999998807907104")

# FR13 壁側プロファイル と デッキFR13C を結ぶブラケット（1501）
bracketPramB = part.CreateBracketParam()
bracketPramB.DefinitionType=1
bracketPramB.BracketName="HK.Bkt.FR13.Side_to_DeckC"
bracketPramB.MaterialName="SS400"
bracketPramB.BaseElement=profile15[0]
bracketPramB.UseSideSheetForPlane=False
bracketPramB.Mold="+"
bracketPramB.Thickness="8"
bracketPramB.BracketType=1501
bracketPramB.Scallop1Type=1801
bracketPramB.Scallop1Params=["0"]
bracketPramB.Scallop2Type=0
bracketPramB.Surfaces1=[profile15[0]+",FL"]
bracketPramB.RevSf1=False
bracketPramB.Surfaces2=[profile7[0]+",FL"]
bracketPramB.RevSf2=False
bracketPramB.RevSf3=False
bracketPramB.Sf1DimensionType=1531
bracketPramB.Sf1DimensonParams=["250","15"]
bracketPramB.Sf2DimensionType=1531
bracketPramB.Sf2DimensonParams=["250","15"]
bktB = part.CreateBracket(bracketPramB,False)
part.BlankElement(bktB,True)
part.SetElementColor(bktB,"0","255","255","0.19999998807907104")

# FR09 壁側プロファイル と デッキFR09P を結ぶブラケット（1501）
bracketPramC = part.CreateBracketParam()
bracketPramC.DefinitionType=1
bracketPramC.BracketName="HK.Bkt.FR09.Side_to_DeckP"
bracketPramC.MaterialName="SS400"
bracketPramC.BaseElement=profile23[0]
bracketPramC.UseSideSheetForPlane=False
bracketPramC.Mold="+"
bracketPramC.Thickness="8"
bracketPramC.BracketType=1501
bracketPramC.Scallop1Type=1801
bracketPramC.Scallop1Params=["0"]
bracketPramC.Scallop2Type=0
bracketPramC.Surfaces1=[profile23[0]+",FL"]
bracketPramC.RevSf1=False
bracketPramC.Surfaces2=[profile21[0]+",FL"]
bracketPramC.RevSf2=False
bracketPramC.RevSf3=False
bracketPramC.Sf1DimensionType=1531
bracketPramC.Sf1DimensonParams=["250","15"]
bracketPramC.Sf2DimensionType=1531
bracketPramC.Sf2DimensonParams=["250","15"]
bktC = part.CreateBracket(bracketPramC,False)
part.BlankElement(bktC,True)
part.SetElementColor(bktC,"0","255","255","0.19999998807907104")

# FR09 壁側プロファイル と デッキFR09C を結ぶブラケット（1501）
bracketPramD = part.CreateBracketParam()
bracketPramD.DefinitionType=1
bracketPramD.BracketName="HK.Bkt.FR09.Side_to_DeckC"
bracketPramD.MaterialName="SS400"
bracketPramD.BaseElement=profile23[0]
bracketPramD.UseSideSheetForPlane=False
bracketPramD.Mold="+"
bracketPramD.Thickness="8"
bracketPramD.BracketType=1501
bracketPramD.Scallop1Type=1801
bracketPramD.Scallop1Params=["0"]
bracketPramD.Scallop2Type=0
bracketPramD.Surfaces1=[profile23[0]+",FL"]
bracketPramD.RevSf1=False
bracketPramD.Surfaces2=[profile22[0]+",FL"]
bracketPramD.RevSf2=False
bracketPramD.RevSf3=False
bracketPramD.Sf1DimensionType=1531
bracketPramD.Sf1DimensonParams=["250","15"]
bracketPramD.Sf2DimensionType=1531
bracketPramD.Sf2DimensonParams=["250","15"]
bktD = part.CreateBracket(bracketPramD,False)
part.BlankElement(bktD,True)
part.SetElementColor(bktD,"0","255","255","0.19999998807907104")

# FR11 壁側プロファイル と デッキD板（シート）を結ぶブラケット（1505）
bracketPramE = part.CreateBracketParam()
bracketPramE.DefinitionType=1
bracketPramE.BracketName="HK.Bkt.FR11.Side_to_DeckSheetD"
bracketPramE.MaterialName="SS400"
bracketPramE.BaseElement=profile12[0]
bracketPramE.UseSideSheetForPlane=False
bracketPramE.Mold="+"
bracketPramE.Thickness="10"
bracketPramE.BracketType=1505
bracketPramE.Scallop1Type=1801
bracketPramE.Scallop1Params=["0"]
bracketPramE.Scallop2Type=0
bracketPramE.Surfaces1=[profile12[0]+",FL"]
bracketPramE.RevSf1=False
bracketPramE.Surfaces2=[extrude_sheet4]
bracketPramE.RevSf2=False
bracketPramE.RevSf3=False
bracketPramE.Sf1DimensionType=1531
bracketPramE.Sf1DimensonParams=["220","15"]
bracketPramE.Sf2DimensionType=1531
bracketPramE.Sf2DimensonParams=["220","15"]
bktE = part.CreateBracket(bracketPramE,False)
part.BlankElement(bktE,True)
part.SetElementColor(bktE,"0","255","255","0.19999998807907104")

# FR10 壁側プロファイル と デッキD板（シート）を結ぶブラケット（1505）
bracketPramF = part.CreateBracketParam()
bracketPramF.DefinitionType=1
bracketPramF.BracketName="HK.Bkt.FR10.Side_to_DeckSheetD"
bracketPramF.MaterialName="SS400"
bracketPramF.BaseElement=profile16[0]
bracketPramF.UseSideSheetForPlane=False
bracketPramF.Mold="+"
bracketPramF.Thickness="10"
bracketPramF.BracketType=1505
bracketPramF.Scallop1Type=1801
bracketPramF.Scallop1Params=["0"]
bracketPramF.Scallop2Type=0
bracketPramF.Surfaces1=[profile16[0]+",FL"]
bracketPramF.RevSf1=False
bracketPramF.Surfaces2=[extrude_sheet4]
bracketPramF.RevSf2=False
bracketPramF.RevSf3=False
bracketPramF.Sf1DimensionType=1531
bracketPramF.Sf1DimensonParams=["220","15"]
bracketPramF.Sf2DimensionType=1531
bracketPramF.Sf2DimensonParams=["220","15"]
bktF = part.CreateBracket(bracketPramF,False)
part.BlankElement(bktF,True)
part.SetElementColor(bktF,"0","255","255","0.19999998807907104")

# デッキDL02プロファイル と 壁Fore板（シート）を結ぶブラケット（1505）
bracketPramG = part.CreateBracketParam()
bracketPramG.DefinitionType=1
bracketPramG.BracketName="HK.Bkt.DL02P_to_WallForeSheet"
bracketPramG.MaterialName="SS400"
bracketPramG.BaseElement=profile6[0]
bracketPramG.UseSideSheetForPlane=False
bracketPramG.Mold="+"
bracketPramG.Thickness="8"
bracketPramG.BracketType=1505
bracketPramG.Scallop1Type=1801
bracketPramG.Scallop1Params=["0"]
bracketPramG.Scallop2Type=0
bracketPramG.Surfaces1=[profile6[0]+",FL"]
bracketPramG.RevSf1=False
bracketPramG.Surfaces2=[extrude_sheet2]
bracketPramG.RevSf2=False
bracketPramG.RevSf3=False
bracketPramG.Sf1DimensionType=1531
bracketPramG.Sf1DimensonParams=["200","15"]
bracketPramG.Sf2DimensionType=1531
bracketPramG.Sf2DimensonParams=["200","15"]
bktG = part.CreateBracket(bracketPramG,False)
part.BlankElement(bktG,True)
part.SetElementColor(bktG,"0","255","255","0.19999998807907104")

# 壁Aft DL02プロファイル と デッキDL02プロファイルを結ぶブラケット（1501）
bracketPramH = part.CreateBracketParam()
bracketPramH.DefinitionType=1
bracketPramH.BracketName="HK.Bkt.DL02_Aft_to_Deck"
bracketPramH.MaterialName="SS400"
bracketPramH.BaseElement=profile10[0]
bracketPramH.UseSideSheetForPlane=False
bracketPramH.Mold="+"
bracketPramH.Thickness="8"
bracketPramH.BracketType=1501
bracketPramH.Scallop1Type=1801
bracketPramH.Scallop1Params=["0"]
bracketPramH.Scallop2Type=0
bracketPramH.Surfaces1=[profile10[0]+",FL"]
bracketPramH.RevSf1=False
bracketPramH.Surfaces2=[profile6[1]+",FL"]
bracketPramH.RevSf2=False
bracketPramH.RevSf3=False
bracketPramH.Sf1DimensionType=1531
bracketPramH.Sf1DimensonParams=["220","15"]
bracketPramH.Sf2DimensionType=1531
bracketPramH.Sf2DimensonParams=["220","15"]
bktH = part.CreateBracket(bracketPramH,False)
part.BlankElement(bktH,True)
part.SetElementColor(bktH,"0","255","255","0.19999998807907104")

# DL03（Fore）プロファイル と DL03（Deck）プロファイルを結ぶブラケット（1501）
bracketPramI = part.CreateBracketParam()
bracketPramI.DefinitionType=1
bracketPramI.BracketName="HK.Bkt.DL03_Fore_to_Deck"
bracketPramI.MaterialName="SS400"
bracketPramI.BaseElement=profile24[0]
bracketPramI.UseSideSheetForPlane=False
bracketPramI.Mold="+"
bracketPramI.Thickness="8"
bracketPramI.BracketType=1501
bracketPramI.Scallop1Type=1801
bracketPramI.Scallop1Params=["0"]
bracketPramI.Scallop2Type=0
bracketPramI.Surfaces1=[profile24[0]+",FL"]
bracketPramI.RevSf1=False
bracketPramI.Surfaces2=[profile18[0]+",FL"]
bracketPramI.RevSf2=False
bracketPramI.RevSf3=False
bracketPramI.Sf1DimensionType=1531
bracketPramI.Sf1DimensonParams=["200","15"]
bracketPramI.Sf2DimensionType=1531
bracketPramI.Sf2DimensonParams=["200","15"]
bktI = part.CreateBracket(bracketPramI,False)
part.BlankElement(bktI,True)
part.SetElementColor(bktI,"0","255","255","0.19999998807907104")

# FR08 壁側プロファイル と デッキD板（シート）を結ぶブラケット（1505）
bracketPramJ = part.CreateBracketParam()
bracketPramJ.DefinitionType=1
bracketPramJ.BracketName="HK.Bkt.FR08.Side_to_DeckSheetD"
bracketPramJ.MaterialName="SS400"
bracketPramJ.BaseElement=profile4[0]
bracketPramJ.UseSideSheetForPlane=False
bracketPramJ.Mold="+"
bracketPramJ.Thickness="8"
bracketPramJ.BracketType=1505
bracketPramJ.Scallop1Type=1801
bracketPramJ.Scallop1Params=["0"]
bracketPramJ.Scallop2Type=0
bracketPramJ.Surfaces1=[profile4[0]+",FL"]
bracketPramJ.RevSf1=False
bracketPramJ.Surfaces2=[extrude_sheet4]
bracketPramJ.RevSf2=False
bracketPramJ.RevSf3=False
bracketPramJ.Sf1DimensionType=1531
bracketPramJ.Sf1DimensonParams=["200","15"]
bracketPramJ.Sf2DimensionType=1531
bracketPramJ.Sf2DimensonParams=["200","15"]
bktJ = part.CreateBracket(bracketPramJ,False)
part.BlankElement(bktJ,True)
part.SetElementColor(bktJ,"0","255","255","0.19999998807907104")
