...
# 追加: 構造的に弱い接合部にブラケットを配置（FR13・FR09）
# FR13（Side FR13.CDP と Deck FR13P の取り合い）
bracketPram_FR13 = part.CreateBracketParam()
bracketPram_FR13.DefinitionType=1
bracketPram_FR13.BracketName="HK.Casing.Wall.Side.FR13.Deck.DP"
bracketPram_FR13.MaterialName="SS400"
bracketPram_FR13.BaseElement=profile15[0]
...
bracketPram_FR13.Surfaces2=[profile14[0]+",FL"]
...
bracket_FR13 = part.CreateBracket(bracketPram_FR13,False)
part.BlankElement(bracket_FR13,True)
part.SetElementColor(bracket_FR13,"0","255","255","0.19999998807907104")
separated_bkt_FR13 = part.BodyDivideByCurves("Separe body by curves_FR13_BKT",bracket_FR13,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bkt_FR13[0],"0","255","255","0.19999998807907104")

# FR09（Side FR09.CDP と Deck FR09P の取り合い）
bracketPram_FR09 = part.CreateBracketParam()
bracketPram_FR09.DefinitionType=1
bracketPram_FR09.BracketName="HK.Casing.Wall.Side.FR09.Deck.DP"
bracketPram_FR09.MaterialName="SS400"
bracketPram_FR09.BaseElement=profile23[0]
bracketPram_FR09.UseSideSheetForPlane=False
bracketPram_FR09.Mold="+"
bracketPram_FR09.Thickness="8"
bracketPram_FR09.BracketType=1501
bracketPram_FR09.Scallop1Type=1801
bracketPram_FR09.Scallop1Params=["0"]
bracketPram_FR09.Scallop2Type=0
bracketPram_FR09.Surfaces1=[profile23[0]+",FL"]
bracketPram_FR09.RevSf1=False
bracketPram_FR09.Surfaces2=[profile21[0]+",FL"]
bracketPram_FR09.RevSf2=False
bracketPram_FR09.RevSf3=False
bracketPram_FR09.Sf1DimensionType=1531
bracketPram_FR09.Sf1DimensonParams=["250","15"]
bracketPram_FR09.Sf2DimensionType=1531
bracketPram_FR09.Sf2DimensonParams=["250","15"]
bracket_FR09 = part.CreateBracket(bracketPram_FR09,False)
part.BlankElement(bracket_FR09,True)
part.SetElementColor(bracket_FR09,"0","255","255","0.19999998807907104")
separated_bkt_FR09 = part.BodyDivideByCurves("Separe body by curves_FR09_BKT",bracket_FR09,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bkt_FR09[0],"0","255","255","0.19999998807907104")
