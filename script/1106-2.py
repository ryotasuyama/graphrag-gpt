...
# ------------------------------------------------------------
# Brackets added per instruction
# 1) bracket1: Base profile7[0], connect profile7 FL <-> profile6 FL, type 1501
...
bracketPram1.Sf1DimensonParams=["250","15"]
bracketPram1.Sf2DimensionType=1531
bracketPram1.Sf2DimensonParams=["250","15"]
...
# 2) bracket2: Base profile12[0], connect profile12 FL <-> profile4 FL, type 1501
...
bracketPram2.Surfaces1=[profile12[0]+",FL"]
bracketPram2.RevSf1=False
bracketPram2.Surfaces2=[profile4[0]+",FL"]
bracketPram2.RevSf2=False
bracketPram2.RevSf3=False
bracketPram2.Sf1DimensionType=1531
bracketPram2.Sf1DimensonParams=["250","15"]
bracketPram2.Sf2DimensionType=1531
bracketPram2.Sf2DimensonParams=["250","15"]
...
# 3) bracket3: Base profile14[0], connect profile14 FL <-> profile4 WF, type 1501
...
# 4) bracket4: Base profile13[0], connect solid1 face <-> profile13 FL, type 1505
...
bracketPram4.Mold="+"
bracketPram4.Thickness="8"
bracketPram4.BracketType=1505
bracketPram4.Scallop1Type=1801
bracketPram4.Scallop1Params=["0"]
bracketPram4.Scallop2Type=0
# Solid face via PLS helper (see sample_sasagawa)
bracketPram4.Surfaces1=["PLS","True","False","0","-0","1",solid1]
...
# 5) bracket5: Base profile11[0], connect profile11 FL <-> profile4 FL, type 1501
...
# 6) bracket6: Base profile25[0], connect profile25 FL <-> profile24 FL, type 1501
