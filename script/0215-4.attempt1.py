...
bracketPram1.BracketName="HK.Casing.Wall.Side.FR15.Deck.DP"
bracketPram1.MaterialName="SS400"
bracketPram1.BaseElement=profile3[0]
...
bracketPram1.Surfaces2=[profile3[0]+",FL"]
...
bracketPram2.BaseElement=profile5[0]
...
# FIX: BracketType=1505 では Surfaces1 に solid 参照(PLS...)を与えると失敗するケースがあるため、
# 同ブロック内の最小変更として Surfaces1 を BaseElement のフランジ面参照に合わせる。
bracketPram2.Surfaces1=[profile5[0]+",FL"]
bracketPram2.RevSf1=False
bracketPram2.Surfaces2=[profile5[0]+",FL"]
...
bracketPram4.BaseElement=profile10[0]
...
bracketPram4.Surfaces2=[profile10[0]+",FL"]
...
bracketPram5.BracketName="HK.Casing.Wall.Side.FR14.Deck.DP"
bracketPram5.MaterialName="SS400"
bracketPram5.BaseElement=profile21[0]
...
bracketPram5.Surfaces2=[profile21[0]+",FL"]
...
bracketPram7.BracketName="HK.Casing.Wall.Fore.DL02.Deck.DP"
...
bracketPram7.Surfaces1=[profile59[0]+",FL"]
bracketPram7.RevSf1=False
bracketPram7.Surfaces2=[profile18[1]+",FL"]
...
bracketPram10.BaseElement=profile75[0]
...
bracketPram10.Surfaces1=[profile75[0]+",FL"]
bracketPram10.RevSf1=False
bracketPram10.Surfaces2=[profile23[0]+",FL"]
...
bracketPram11.BracketName="HK.Casing.Wall.Fore.DL01.Deck.DP"
...
bracketPram11.Surfaces2=[profile61[0]+",FL"]
...
bracketPram12.BracketName="HK.Casing.Wall.Aft.DL03.Deck.DP"
...
bracketPram13.BracketName="HK.Casing.Wall.Fore.DL03.Deck.DP"
...
bracketPram14.BracketName="HK.Casing.Wall.Aft.DL05.Deck.DP"
...
bracketPram15.BracketName="HK.Casing.Wall.Fore.DL05.Deck.DP"
