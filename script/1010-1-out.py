...
extrudePram8.RefByGeometricMethod=False
...
skt_ln19 = part.CreateSketchLine(skt_pl3,"","デフォルト","2926.4779204678048,400","12241.442807836524,400",False)
...
ProfilePram6.BasePlane="PL,O,"+var_elm5+","+"Y"
...
ProfilePram8.BasePlane="PL,O,"+var_elm7+","+"Y"
...
ProfilePram9.BasePlane="PL,O,"+var_elm7+","+"Y"
...
separated_bodies1 = part.BodyDivideByCurves("Separe body by curves5",profile7[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies1[0],"148","0","211","0.39999997615814209")
part.SetElementColor(separated_bodies1[1],"148","0","211","0.39999997615814209")
...
ProfilePram13.BasePlane="PL,O,"+var_elm5+","+"Y"
...
separated_bodies2 = part.BodyDivideByCurves("Separe body by curves41",profile19[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies2[0],"255","0","0","0.19999998807907104")
...
extrudePram14.RefByGeometricMethod=False
...
separated_bodies3 = part.BodyDivideByCurves("Separe body by curves31",profile24[0],[skt_pl3],False,"0","","",False)
...
separated_bodies4 = part.BodyDivideByCurves("Separe body by curves20",profile18[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies4[0],"255","0","0","0.19999998807907104")
separated_bodies5 = part.BodyDivideByCurves("Separe body by curves32",profile9[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies5[0],"0","255","255","0.19999998807907104")
separated_bodies6 = part.BodyDivideByCurves("Separe body by curves54",profile10[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies6[0],"148","0","211","0.38999998569488525")
separated_bodies7 = part.BodyDivideByCurves("Separe body by curves11",profile12[0],[skt_pl3],False,"0","","",False)
...
ProfilePram26.AddEnd1Elements(profile2[0])
...
separated_bodies8 = part.BodyDivideByCurves("Separe body by curves44",profile26[0],[skt_pl3],False,"0","","",False)
...
separated_bodies9 = part.BodyDivideByCurves("Separe body by curves49",profile15[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies9[0],"148","0","211","0.39999997615814209")
separated_bodies10 = part.BodyDivideByCurves("Separe body by curves39",profile26[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies10[0],"255","0","0","0.19999998807907104")
separated_bodies11 = part.BodyDivideByCurves("Separe body by curves23",profile1[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies11[0],"255","0","0","0.19999998807907104")
...
ProfilePram27.BasePlane="PL,O,"+var_elm14+","+"X"
ProfilePram27.AddAttachSurfaces(extrude_sheet6)
ProfilePram27.ProfileName="HK.Casing.Wall.Side.FR14.CDP"
ProfilePram27.MaterialName="SS400"
ProfilePram27.ProfileType=1002
ProfilePram27.ProfileParams=["150","90","9.0000000000000018","12","6"]
ProfilePram27.Mold="+"
...
ProfilePram27.AddEnd1Elements(extrude_sheet4)
ProfilePram27.End1Type=1102
ProfilePram27.End1TypeParams=["25","29.999999999999996","0","0"]
ProfilePram27.AddEnd2Elements(extrude_sheet1)
ProfilePram27.End2Type=1102
ProfilePram27.End2TypeParams=["25","29.999999999999996","0","0"]
ProfilePram27.End1ScallopType=1121
ProfilePram27.End1ScallopTypeParams=["35","40"]
ProfilePram27.End2ScallopType=1121
ProfilePram27.End2ScallopTypeParams=["35","40"]
...
separated_bodies12 = part.BodyDivideByCurves("Separe body by curves1",solid2,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies12[1],"139","69","19","0.78999996185302734")
part.SetElementColor(separated_bodies12[0],"139","69","19","0.78999996185302734")
separated_bodies13 = part.BodyDivideByCurves("Separe body by curves15",profile22[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies13[0],"148","0","211","0.39999997615814209")
part.SetElementColor(separated_bodies13[1],"148","0","211","0.39999997615814209")
separated_bodies14 = part.BodyDivideByCurves("Separe body by curves2",profile17[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies14[0],"255","0","0","0.19999998807907104")
separated_bodies15 = part.BodyDivideByCurves("Separe body by curves7",profile4[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies15[0],"255","0","0","0.19999998807907104")
separated_bodies16 = part.BodyDivideByCurves("Separe body by curves40",profile20[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies16[0],"255","0","0","0.19999998807907104")
separated_bodies17 = part.BodyDivideByCurves("Separe body by curves21",profile14[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies17[0],"148","0","211","0.39999997615814209")
separated_bodies18 = part.BodyDivideByCurves("Separe body by curves3",profile8[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies18[0],"255","0","0","0.19999998807907104")
separated_bodies19 = part.BodyDivideByCurves("Separe body by curves38",profile19[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies19[0],"0","255","255","0.19999998807907104")
separated_bodies20 = part.BodyDivideByCurves("Separe body by curves27",solid4,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies20[0],"139","69","19","0.79999995231628418")
separated_bodies21 = part.BodyDivideByCurves("Separe body by curves19",profile6[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies21[0],"148","0","211","0.39999997615814209")
separated_bodies22 = part.BodyDivideByCurves("Separe body by curves14",profile16[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies22[0],"255","0","0","0.19999998807907104")
separated_bodies23 = part.BodyDivideByCurves("Separe body by curves4",solid3,[skt_pl3],False,"0","","",False)
...
separated_bodies24 = part.BodyDivideByCurves("Separe body by curves37",profile9[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies24[0],"255","0","0","0.19999998807907104")
separated_bodies25 = part.BodyDivideByCurves("Separe body by curves28",solid1,[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies25[0],"139","69","19","0.79999995231628418")
part.SetElementColor(separated_bodies25[1],"139","69","19","0.79999995231628418")
separated_bodies26 = part.BodyDivideByCurves("Separe body by curves10",profile25[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies26[0],"0","255","255","0.19999998807907104")
separated_bodies27 = part.BodyDivideByCurves("Separe body by curves53",profile6[1],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies27[0],"148","0","211","0.39999997615814209")
separated_bodies28 = part.BodyDivideByCurves("Separe body by curves12",profile21[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies28[0],"148","0","211","0.39999997615814209")
separated_bodies29 = part.BodyDivideByCurves("Separe body by curves26",profile26[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies29[0],"255","0","0","0.19999998807907104")
separated_bodies30 = part.BodyDivideByCurves("Separe body by curves57",profile13[1],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies30[0],"148","0","211","0.39999997615814209")
separated_bodies31 = part.BodyDivideByCurves("Separe body by curves30",profile11[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies31[0],"255","0","0","0.19999998807907104")
separated_bodies32 = part.BodyDivideByCurves("Separe body by curves58",profile10[1],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies32[0],"148","0","211","0.38999998569488525")
separated_bodies33 = part.BodyDivideByCurves("Separe body by curves25",profile5[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies33[0],"255","0","0","0.19999998807907104")
separated_bodies34 = part.BodyDivideByCurves("Separe body by curves22",profile2[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies34[0],"255","0","0","0.19999998807907104")
separated_bodies35 = part.BodyDivideByCurves("Separe body by curves24",profile27[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies35[0],"255","0","0","0.19999998807907104")
separated_bodies36 = part.BodyDivideByCurves("Separe body by curves9",profile25[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies36[0],"255","0","0","0.19999998807907104")
separated_bodies37 = part.BodyDivideByCurves("Separe body by curves51",profile23[0],[skt_pl3],False,"0","","",False)
part.SetElementColor(separated_bodies37[0],"148","0","211","0.39999997615814209")
separated_bodies38 = part.BodyDivideByCurves("Separe body by curves34",profile3[0],[skt_pl3],False,"0","","",False)
