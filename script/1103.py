...
# === 追加: ブラケット（台形板） FR13 側壁プロファイルとデッキ側プロファイルを接続（BracketType=1501）===
brktPrm_FR13 = part.CreateBracketParam()
brktPrm_FR13.DefinitionType = 1
brktPrm_FR13.BracketName = "HK.BKT.FR13.Side_to_DeckD"
brktPrm_FR13.MaterialName = "SS400"
brktPrm_FR13.BaseElement = profile15[0]
brktPrm_FR13.UseSideSheetForPlane = False
brktPrm_FR13.Mold = "+"
brktPrm_FR13.Thickness = "8"
brktPrm_FR13.BracketType = 1501
brktPrm_FR13.Scallop1Type = 1801
brktPrm_FR13.Scallop1Params = ["0"]
brktPrm_FR13.Scallop2Type = 0
brktPrm_FR13.Surfaces1 = [profile15[0]+",FL"]
brktPrm_FR13.RevSf1 = False
brktPrm_FR13.Surfaces2 = [profile14[0]+",FL"]
brktPrm_FR13.RevSf2 = False
brktPrm_FR13.RevSf3 = False
brktPrm_FR13.Sf1DimensionType = 1531
brktPrm_FR13.Sf1DimensonParams = ["250","15"]
brktPrm_FR13.Sf2DimensionType = 1531
brktPrm_FR13.Sf2DimensonParams = ["250","15"]
bracket_FR13 = part.CreateBracket(brktPrm_FR13,False)
part.BlankElement(bracket_FR13,True)
part.SetElementColor(bracket_FR13,"0","255","255","0.19999998807907104")
# 必要に応じて分割
_ = part.BodyDivideByCurves("Separe body by curves_FR13_BKT", bracket_FR13, [skt_pl3], False, "0","","",False)
...
# === 追加: ブラケット（台形板） FR09 側壁プロファイルとデッキ側プロファイルを接続（BracketType=1501）===
brktPrm_FR09 = part.CreateBracketParam()
brktPrm_FR09.DefinitionType = 1
brktPrm_FR09.BracketName = "HK.BKT.FR09.Side_to_DeckD"
brktPrm_FR09.MaterialName = "SS400"
brktPrm_FR09.BaseElement = profile23[0]
brktPrm_FR09.UseSideSheetForPlane = False
brktPrm_FR09.Mold = "+"
brktPrm_FR09.Thickness = "8"
brktPrm_FR09.BracketType = 1501
brktPrm_FR09.Scallop1Type = 1801
brktPrm_FR09.Scallop1Params = ["0"]
brktPrm_FR09.Scallop2Type = 0
brktPrm_FR09.Surfaces1 = [profile23[0]+",FL"]
brktPrm_FR09.RevSf1 = False
brktPrm_FR09.Surfaces2 = [profile21[0]+",FL"]
brktPrm_FR09.RevSf2 = False
brktPrm_FR09.RevSf3 = False
brktPrm_FR09.Sf1DimensionType = 1531
brktPrm_FR09.Sf1DimensonParams = ["250","15"]
brktPrm_FR09.Sf2DimensionType = 1531
brktPrm_FR09.Sf2DimensonParams = ["250","15"]
bracket_FR09 = part.CreateBracket(brktPrm_FR09,False)
part.BlankElement(bracket_FR09,True)
part.SetElementColor(bracket_FR09,"0","255","255","0.19999998807907104")
_ = part.BodyDivideByCurves("Separe body by curves_FR09_BKT", bracket_FR09, [skt_pl3], False, "0","","",False)
...
# === 追加: ブラケット（台形板） DL02（Aft）デッキ側プロファイルとAft壁側プロファイルを接続（BracketType=1505）===
# profile6[1] : HK.Casing.Deck.D.DL02P（Flange側2）、profile10[0] : HK.Casing.Wall.Aft.DL02.CDP
brktPrm_DL02_AFT = part.CreateBracketParam()
brktPrm_DL02_AFT.DefinitionType = 1
brktPrm_DL02_AFT.BracketName = "HK.BKT.DL02.Aft.Deck_to_Wall"
brktPrm_DL02_AFT.MaterialName = "SS400"
brktPrm_DL02_AFT.BaseElement = profile10[0]
brktPrm_DL02_AFT.UseSideSheetForPlane = False
brktPrm_DL02_AFT.Mold = "+"
brktPrm_DL02_AFT.Thickness = "8"
brktPrm_DL02_AFT.BracketType = 1505
brktPrm_DL02_AFT.Scallop1Type = 1801
brktPrm_DL02_AFT.Scallop1Params = ["0"]
brktPrm_DL02_AFT.Scallop2Type = 0
brktPrm_DL02_AFT.Surfaces1 = [profile10[0]+",FL"]
brktPrm_DL02_AFT.RevSf1 = False
brktPrm_DL02_AFT.Surfaces2 = [profile6[1]+",FL"]
brktPrm_DL02_AFT.RevSf2 = False
brktPrm_DL02_AFT.RevSf3 = False
brktPrm_DL02_AFT.Sf1DimensionType = 1531
brktPrm_DL02_AFT.Sf1DimensonParams = ["220","15"]
brktPrm_DL02_AFT.Sf2DimensionType = 1531
brktPrm_DL02_AFT.Sf2DimensonParams = ["220","15"]
bracket_DL02_AFT = part.CreateBracket(brktPrm_DL02_AFT,False)
part.BlankElement(bracket_DL02_AFT,True)
part.SetElementColor(bracket_DL02_AFT,"0","255","255","0.19999998807907104")
_ = part.BodyDivideByCurves("Separe body by curves_DL02_AFT_BKT", bracket_DL02_AFT, [skt_pl3], False, "0","","",False)

# === 追加: ブラケット（台形板） DL02（Fore）デッキ側プロファイルとFore壁側プロファイルを接続（BracketType=1505）===
# profile6[1] : HK.Casing.Deck.D.DL02P（Flange側2）、profile13[0] : HK.Casing.Wall.Fore.DL02.CDP
brktPrm_DL02_FORE = part.CreateBracketParam()
brktPrm_DL02_FORE.DefinitionType = 1
brktPrm_DL02_FORE.BracketName = "HK.BKT.DL02.Fore.Deck_to_Wall"
brktPrm_DL02_FORE.MaterialName = "SS400"
brktPrm_DL02_FORE.BaseElement = profile13[0]
brktPrm_DL02_FORE.UseSideSheetForPlane = False
brktPrm_DL02_FORE.Mold = "+"
brktPrm_DL02_FORE.Thickness = "8"
brktPrm_DL02_FORE.BracketType = 1505
brktPrm_DL02_FORE.Scallop1Type = 1801
brktPrm_DL02_FORE.Scallop1Params = ["0"]
brktPrm_DL02_FORE.Scallop2Type = 0
brktPrm_DL02_FORE.Surfaces1 = [profile13[0]+",FL"]
brktPrm_DL02_FORE.RevSf1 = False
brktPrm_DL02_FORE.Surfaces2 = [profile6[1]+",FL"]
brktPrm_DL02_FORE.RevSf2 = False
brktPrm_DL02_FORE.RevSf3 = False
brktPrm_DL02_FORE.Sf1DimensionType = 1531
brktPrm_DL02_FORE.Sf1DimensonParams = ["220","15"]
brktPrm_DL02_FORE.Sf2DimensionType = 1531
brktPrm_DL02_FORE.Sf2DimensonParams = ["220","15"]
bracket_DL02_FORE = part.CreateBracket(brktPrm_DL02_FORE,False)
part.BlankElement(bracket_DL02_FORE,True)
part.SetElementColor(bracket_DL02_FORE,"0","255","255","0.19999998807907104")
_ = part.BodyDivideByCurves("Separe body by curves_DL02_FORE_BKT", bracket_DL02_FORE, [skt_pl3], False, "0","","",False)