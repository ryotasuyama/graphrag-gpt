...
# --- 追加: できるだけ多くのブラケットを追加（既存要素を利用して安全に追加） ---
# 参考スクリプトのパターン（CreateBracketParam→設定→CreateBracket→色/表示）に合わせ、
# 既存のプロファイル/ソリッド/シートを接続先としてできる範囲で追加します。
# （失敗しやすい条件があるため、1件ずつ try/except で継続）

def _try_create_bracket(param):
    try:
        b = part.CreateBracket(param, False)
        try:
            part.BlankElement(b, True)
        except:
            pass
        try:
            part.SetElementColor(b, "0", "255", "255", "0.19999998807907104")
        except:
            pass
        return b
    except:
...
# Bracket 1: Deck.C (profile54) - Wall.Fore(DL03) (profile53) 周り
bracketPramA1 = part.CreateBracketParam()
bracketPramA1.DefinitionType = 1
bracketPramA1.BracketName = "HK.Auto.Bracket.DeckC_DL03_FP"
bracketPramA1.MaterialName = "SS400"
bracketPramA1.BaseElement = profile54[0]
...
bracketPramA1.Surfaces1 = [profile54[0] + ",FL"]
bracketPramA1.RevSf1 = False
bracketPramA1.Surfaces2 = [profile53[0] + ",FL"]
bracketPramA1.RevSf2 = False
bracketPramA1.RevSf3 = False
bracketPramA1.Sf1DimensionType = 1531
bracketPramA1.Sf1DimensonParams = ["250", "15"]
bracketPramA1.Sf2DimensionType = 1531
bracketPramA1.Sf2DimensonParams = ["250", "15"]
bracketA1 = _try_create_bracket(bracketPramA1)

# Bracket 2: Deck.B (profile114) - Wall.Fore(DL03) (profile25) 周り
bracketPramA2 = part.CreateBracketParam()
bracketPramA2.DefinitionType = 1
bracketPramA2.BracketName = "HK.Auto.Bracket.DeckB_DL03_FP"
bracketPramA2.MaterialName = "SS400"
bracketPramA2.BaseElement = profile114[0]
bracketPramA2.UseSideSheetForPlane = False
bracketPramA2.Mold = "+"
bracketPramA2.Thickness = "8"
bracketPramA2.BracketType = 1501
bracketPramA2.Scallop1Type = 1801
bracketPramA2.Scallop1Params = ["0"]
bracketPramA2.Scallop2Type = 0
bracketPramA2.Surfaces1 = [profile114[0] + ",FL"]
bracketPramA2.RevSf1 = False
bracketPramA2.Surfaces2 = [profile25[0] + ",FL"]
bracketPramA2.RevSf2 = False
bracketPramA2.RevSf3 = False
bracketPramA2.Sf1DimensionType = 1531
bracketPramA2.Sf1DimensonParams = ["250", "15"]
bracketPramA2.Sf2DimensionType = 1531
bracketPramA2.Sf2DimensonParams = ["250", "15"]
bracketA2 = _try_create_bracket(bracketPramA2)

# Bracket 3: Deck.A (profile108) - Wall.Fore(DL03.OAP) (profile107)
bracketPramA3 = part.CreateBracketParam()
bracketPramA3.DefinitionType = 1
bracketPramA3.BracketName = "HK.Auto.Bracket.DeckA_DL03_FP"
bracketPramA3.MaterialName = "SS400"
bracketPramA3.BaseElement = profile108[0]
bracketPramA3.UseSideSheetForPlane = False
bracketPramA3.Mold = "+"
bracketPramA3.Thickness = "8"
bracketPramA3.BracketType = 1501
bracketPramA3.Scallop1Type = 1801
bracketPramA3.Scallop1Params = ["0"]
bracketPramA3.Scallop2Type = 0
bracketPramA3.Surfaces1 = [profile108[0] + ",FL"]
bracketPramA3.RevSf1 = False
bracketPramA3.Surfaces2 = [profile107[0] + ",FL"]
bracketPramA3.RevSf2 = False
bracketPramA3.RevSf3 = False
bracketPramA3.Sf1DimensionType = 1531
bracketPramA3.Sf1DimensonParams = ["250", "15"]
bracketPramA3.Sf2DimensionType = 1531
bracketPramA3.Sf2DimensonParams = ["250", "15"]
bracketA3 = _try_create_bracket(bracketPramA3)

# Bracket 4: Deck.D (profile17) - Wall.Aft(DL05.CDP) (profile72)
bracketPramA4 = part.CreateBracketParam()
bracketPramA4.DefinitionType = 1
bracketPramA4.BracketName = "HK.Auto.Bracket.DeckD_DL05P"
bracketPramA4.MaterialName = "SS400"
bracketPramA4.BaseElement = profile17[0]
bracketPramA4.UseSideSheetForPlane = False
bracketPramA4.Mold = "+"
bracketPramA4.Thickness = "8"
bracketPramA4.BracketType = 1501
bracketPramA4.Scallop1Type = 1801
bracketPramA4.Scallop1Params = ["0"]
bracketPramA4.Scallop2Type = 0
bracketPramA4.Surfaces1 = [profile17[0] + ",FL"]
bracketPramA4.RevSf1 = False
bracketPramA4.Surfaces2 = [profile72[0] + ",FL"]
bracketPramA4.RevSf2 = False
bracketPramA4.RevSf3 = False
bracketPramA4.Sf1DimensionType = 1531
bracketPramA4.Sf1DimensonParams = ["200", "15"]
bracketPramA4.Sf2DimensionType = 1531
bracketPramA4.Sf2DimensonParams = ["200", "15"]
bracketA4 = _try_create_bracket(bracketPramA4)

# Bracket 5: Deck.C (profile8) - Wall.Aft(DL05.BCP) (profile7)
bracketPramA5 = part.CreateBracketParam()
bracketPramA5.DefinitionType = 1
bracketPramA5.BracketName = "HK.Auto.Bracket.DeckC_DL05P"
bracketPramA5.MaterialName = "SS400"
bracketPramA5.BaseElement = profile8[0]
bracketPramA5.UseSideSheetForPlane = False
bracketPramA5.Mold = "+"
bracketPramA5.Thickness = "8"
bracketPramA5.BracketType = 1501
bracketPramA5.Scallop1Type = 1801
bracketPramA5.Scallop1Params = ["0"]
bracketPramA5.Scallop2Type = 0
bracketPramA5.Surfaces1 = [profile8[0] + ",FL"]
bracketPramA5.RevSf1 = False
bracketPramA5.Surfaces2 = [profile7[0] + ",FL"]
bracketPramA5.RevSf2 = False
bracketPramA5.RevSf3 = False
bracketPramA5.Sf1DimensionType = 1531
bracketPramA5.Sf1DimensonParams = ["200", "15"]
bracketPramA5.Sf2DimensionType = 1531
bracketPramA5.Sf2DimensonParams = ["200", "15"]
bracketA5 = _try_create_bracket(bracketPramA5)

# Bracket 6: Deck.A (profile47) - Wall.Fore(DL05.OAP) (profile46)
bracketPramA6 = part.CreateBracketParam()
bracketPramA6.DefinitionType = 1
bracketPramA6.BracketName = "HK.Auto.Bracket.DeckA_DL05P"
bracketPramA6.MaterialName = "SS400"
bracketPramA6.BaseElement = profile47[0]
bracketPramA6.UseSideSheetForPlane = False
bracketPramA6.Mold = "+"
bracketPramA6.Thickness = "8"
bracketPramA6.BracketType = 1501
bracketPramA6.Scallop1Type = 1801
bracketPramA6.Scallop1Params = ["0"]
bracketPramA6.Scallop2Type = 0
bracketPramA6.Surfaces1 = [profile47[0] + ",FL"]
bracketPramA6.RevSf1 = False
bracketPramA6.Surfaces2 = [profile46[0] + ",FL"]
bracketPramA6.RevSf2 = False
bracketPramA6.RevSf3 = False
bracketPramA6.Sf1DimensionType = 1531
bracketPramA6.Sf1DimensonParams = ["200", "15"]
bracketPramA6.Sf2DimensionType = 1531
bracketPramA6.Sf2DimensonParams = ["200", "15"]
bracketA6 = _try_create_bracket(bracketPramA6)

# Bracket 7: Wall.Side FR10 (profile44) - Deck.D ソリッド（solid2）
bracketPramA7 = part.CreateBracketParam()
bracketPramA7.DefinitionType = 1
bracketPramA7.BracketName = "HK.Auto.Bracket.SideFR10_DeckD"
bracketPramA7.MaterialName = "SS400"
bracketPramA7.BaseElement = profile44[0]
bracketPramA7.UseSideSheetForPlane = False
bracketPramA7.Mold = "+"
bracketPramA7.Thickness = "10"
bracketPramA7.BracketType = 1505
bracketPramA7.BracketParams = ["200"]
bracketPramA7.Scallop1Type = 1801
bracketPramA7.Scallop1Params = ["0"]
bracketPramA7.Scallop2Type = 0
bracketPramA7.Surfaces1 = ["PLS", "False", "False", "0", "-0", "-1", solid2]
bracketPramA7.RevSf1 = False
bracketPramA7.Surfaces2 = [profile44[0] + ",FL"]
bracketPramA7.RevSf2 = False
bracketPramA7.RevSf3 = False
bracketPramA7.Sf1DimensionType = 1541
bracketPramA7.Sf1DimensonParams = ["0", "100"]
bracketPramA7.Sf1EndElements = ["PLS", "False", "False", "-0", "-1", "-0", profile17[0]]
bracketPramA7.Sf2DimensionType = 1531
bracketPramA7.Sf2DimensonParams = ["200", "15"]
bracketA7 = _try_create_bracket(bracketPramA7)

# Bracket 8: Wall.Side FR11 (profile111) - Deck.D ソリッド（solid2）
bracketPramA8 = part.CreateBracketParam()
bracketPramA8.DefinitionType = 1
bracketPramA8.BracketName = "HK.Auto.Bracket.SideFR11_DeckD"
bracketPramA8.MaterialName = "SS400"
bracketPramA8.BaseElement = profile111[0]
bracketPramA8.UseSideSheetForPlane = False
bracketPramA8.Mold = "+"
bracketPramA8.Thickness = "10"
bracketPramA8.BracketType = 1505
bracketPramA8.BracketParams = ["200"]
bracketPramA8.Scallop1Type = 1801
bracketPramA8.Scallop1Params = ["0"]
bracketPramA8.Scallop2Type = 0
bracketPramA8.Surfaces1 = ["PLS", "False", "False", "0", "-0", "-1", solid2]
bracketPramA8.RevSf1 = False
bracketPramA8.Surfaces2 = [profile111[0] + ",FL"]
bracketPramA8.RevSf2 = False
bracketPramA8.RevSf3 = False
bracketPramA8.Sf1DimensionType = 1541
bracketPramA8.Sf1DimensonParams = ["0", "100"]
bracketPramA8.Sf1EndElements = ["PLS", "False", "False", "-0", "-1", "-0", profile17[0]]
bracketPramA8.Sf2DimensionType = 1531
bracketPramA8.Sf2DimensonParams = ["200", "15"]
bracketA8 = _try_create_bracket(bracketPramA8)

# Bracket 9: Wall.Fore DL02 (profile97) - Deck.A (profile50) 周り（片側）
bracketPramA9 = part.CreateBracketParam()
bracketPramA9.DefinitionType = 1
bracketPramA9.BracketName = "HK.Auto.Bracket.ForeDL02_DeckA_DL00F"
bracketPramA9.MaterialName = "SS400"
bracketPramA9.BaseElement = profile97[0]
bracketPramA9.UseSideSheetForPlane = False
bracketPramA9.Mold = "-"
bracketPramA9.Thickness = "12"
bracketPramA9.BracketType = 1501
bracketPramA9.Scallop1Type = 1801
bracketPramA9.Scallop1Params = ["50"]
bracketPramA9.Scallop2Type = 0
bracketPramA9.Surfaces1 = [profile97[0] + ",FL"]
bracketPramA9.RevSf1 = False
bracketPramA9.Surfaces2 = [profile50[0] + ",FL"]
bracketPramA9.RevSf2 = False
bracketPramA9.RevSf3 = False
bracketPramA9.Sf1DimensionType = 1531
bracketPramA9.Sf1DimensonParams = ["300", "15"]
bracketPramA9.Sf2DimensionType = 1531
bracketPramA9.Sf2DimensonParams = ["300", "15"]
bracketA9 = _try_create_bracket(bracketPramA9)

# Bracket 10: Wall.Aft DL02 (profile19) - Deck.C(plate) solid1 周り（片側）
bracketPramA10 = part.CreateBracketParam()
bracketPramA10.DefinitionType = 1
bracketPramA10.BracketName = "HK.Auto.Bracket.AftDL02_DeckC"
bracketPramA10.MaterialName = "SS400"
bracketPramA10.BaseElement = profile19[0]
bracketPramA10.UseSideSheetForPlane = False
bracketPramA10.Mold = "-"
bracketPramA10.Thickness = "12"
bracketPramA10.BracketType = 1505
bracketPramA10.BracketParams = ["200"]
bracketPramA10.Scallop1Type = 1801
bracketPramA10.Scallop1Params = ["50"]
bracketPramA10.Scallop2Type = 0
bracketPramA10.Surfaces1 = ["PLS", "False", "False", "0", "-0", "-1", solid1]
bracketPramA10.RevSf1 = False
bracketPramA10.Surfaces2 = [profile19[0] + ",FL"]
bracketPramA10.RevSf2 = False
bracketPramA10.RevSf3 = False
bracketPramA10.Sf1DimensionType = 1541
bracketPramA10.Sf1DimensonParams = ["0", "100"]
bracketPramA10.Sf1EndElements = ["PLS", "False", "False", "-0", "-1", "-0", profile8[0]]
bracketPramA10.Sf2DimensionType = 1531
bracketPramA10.Sf2DimensonParams = ["200", "15"]
bracketA10 = _try_create_bracket(bracketPramA10)