...
bracketPram1.BaseElement=profile13[0]
...
bracketPram1.Surfaces2=[profile13[0]+",FL"]
...
bracketPram2.BracketName="HK.Casing.Wall.Side.FR12.Deck.DP"
bracketPram2.MaterialName="SS400"
bracketPram2.BaseElement=profile2[0]
...
bracketPram2.Surfaces2=[profile2[0]+",FL"]
...
bracketPram3.BracketName="HK.Casing.Wall.Side.FR14.Deck.DP"
bracketPram3.MaterialName="SS400"
bracketPram3.BaseElement=profile29[0]
...
bracketPram3.Surfaces2=[profile29[0]+",FL"]
...
bracketPram4.BracketName="HK.Casing.Wall.Side.FR07.Deck.DP"
bracketPram4.MaterialName="SS400"
bracketPram4.BaseElement=profile8[0]
...
bracketPram4.Surfaces2=[profile8[0]+",FL"]
...
bracketPram6.BracketName="HK.Casing.Wall.Side.FR11.Deck.DP"
bracketPram6.MaterialName="SS400"
bracketPram6.BaseElement=profile9[0]
...
bracketPram6.Surfaces2=[profile9[0]+",FL"]
...
bracketPram7.BracketName="HK.Casing.Wall.Side.FR15.Deck.DP"
...
bracketPram8.BracketName="HK.Casing.Wall.Aft.DL01.Deck.DP"
bracketPram8.MaterialName="SS400"
bracketPram8.BaseElement=profile28[0]
...
bracketPram8.Surfaces1=[profile28[0]+",FL"]
bracketPram8.RevSf1=False
bracketPram8.Surfaces2=[profile27[0]+",FL"]
...
bracketPram9.BaseElement=profile17[0]
...
bracketPram9.Surfaces1=[profile17[0]+",FL"]
...
bracketPram10.BaseElement=profile25[0]
...
bracketPram10.Surfaces1=[profile25[0]+",FL"]
bracketPram10.RevSf1=False
bracketPram10.Surfaces2=[profile24[0]+",FL"]
...
bracketPram11.BaseElement=profile18[0]
...
bracketPram11.Surfaces1=[profile18[0]+",FL"]
bracketPram11.RevSf1=False
bracketPram11.Surfaces2=[profile1[0]+",FL"]
...
bracketPram12.BaseElement=profile22[0]
...
bracketPram12.Surfaces1=[profile22[0]+",FL"]
...
bracketPram13.BracketName="HK.Casing.Wall.Fore.DL04.Deck.DP"
bracketPram13.MaterialName="SS400"
bracketPram13.BaseElement=profile26[0]
...
bracketPram13.Surfaces1=[profile26[0]+",FL"]
bracketPram13.RevSf1=False
bracketPram13.Surfaces2=[profile24[0]+",FL"]
...
bracketPram14.BracketName="HK.Casing.Wall.Fore.DL05.Deck.DP"
bracketPram14.MaterialName="SS400"
bracketPram14.BaseElement=profile10[0]
...
bracketPram14.Surfaces1=[profile10[0]+",FL"]
bracketPram14.RevSf1=False
bracketPram14.Surfaces2=[profile1[0]+",FL"]
...
bracketPram15.BaseElement=profile21[0]
...
bracketPram15.Surfaces1=[profile21[0]+",FL"]
...
bracketPram16.BaseElement=profile15[0]
...
bracketPram16.Surfaces1=[profile15[0]+",FL"]
bracketPram16.RevSf1=False
bracketPram16.Surfaces2=[profile14[0]+",FL"]
...
bracketPram19.BracketName="HK.Casing.Deck.D.FR13P"
bracketPram19.MaterialName="SS400"
bracketPram19.BaseElement=profile14[0]
...
bracketPram19.Surfaces1=[profile4[0]+",WF"]
bracketPram19.RevSf1=False
bracketPram19.Surfaces2=[profile14[0]+",FL"]
...
bracketPram19.Sf1EndElements=[profile4[1]+",FR"]
...
bracketPram20.Surfaces1=[profile4[0]+",WF"]
bracketPram20.RevSf1=False
bracketPram20.Surfaces2=[profile19[0]+",FL"]
...
bracketPram20.Sf1EndElements=[profile4[1]+",FR"]
...
bracketPram21.BracketName="HK.Casing.Deck.D.FR13P.B"
...
bracketPram21.Surfaces1=[profile4[0]+",WB"]
bracketPram21.RevSf1=False
bracketPram21.Surfaces2=[profile5[0]+",FL"]
...
bracketPram22.BracketName="HK.Casing.Deck.D.FR09P.B"
bracketPram22.MaterialName="SS400"
bracketPram22.BaseElement=profile20[0]
...
bracketPram22.Surfaces1=[profile4[0]+",WB"]
bracketPram22.RevSf1=False
bracketPram22.Surfaces2=[profile20[0]+",FL"]
