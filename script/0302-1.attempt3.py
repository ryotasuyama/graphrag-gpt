...
bracketPram1.BracketName="HK.Casing.Wall.Side.FR07.Deck.DP"
...
bracketPram1.Surfaces2=[profile8[0]+",FL"]
...
bracketPram2.BracketName="HK.Casing.Wall.Side.FR08.Deck.DP"
bracketPram2.MaterialName="SS400"
bracketPram2.BaseElement=profile3[0]
...
bracketPram2.Surfaces2=[profile3[0]+",FL"]
...
bracketPram3.BaseElement=profile13[0]
...
bracketPram3.Surfaces2=[profile13[0]+",FL"]
...
bracketPram5.BaseElement=profile2[0]
...
bracketPram5.Surfaces2=[profile2[0]+",FL"]
...
bracketPram6.BaseElement=profile29[0]
...
bracketPram6.Surfaces2=[profile29[0]+",FL"]
...
bracketPram8.BaseElement=profile7[0]
...
bracketPram8.Surfaces1=[profile7[0]+",FL"]
bracketPram8.RevSf1=False
bracketPram8.Surfaces2=[profile6[0]+",FL"]
...
bracketPram10.BaseElement=profile26[0]
...
bracketPram10.Surfaces1=[profile26[0]+",FL"]
...
bracketPram11.BaseElement=profile10[0]
...
bracketPram11.Surfaces1=[profile10[0]+",FL"]
...
bracketPram12.BaseElement=profile28[0]
...
bracketPram12.Surfaces1=[profile28[0]+",FL"]
bracketPram12.RevSf1=False
bracketPram12.Surfaces2=[profile27[0]+",FL"]
...
bracketPram13.BaseElement=profile17[0]
...
bracketPram13.Surfaces1=[profile17[0]+",FL"]
...
bracketPram14.BracketName="HK.Casing.Wall.Aft.DL04.Deck.DP"
bracketPram14.MaterialName="SS400"
bracketPram14.BaseElement=profile25[0]
...
bracketPram14.Surfaces1=[profile25[0]+",FL"]
bracketPram14.RevSf1=False
bracketPram14.Surfaces2=[profile24[0]+",FL"]
...
bracketPram15.BaseElement=profile18[0]
...
bracketPram15.Surfaces1=[profile18[0]+",FL"]
bracketPram15.RevSf1=False
bracketPram15.Surfaces2=[profile1[0]+",FL"]
...
bracketPram16.Surfaces1=[profile21[0]+",FL"]
bracketPram16.RevSf1=False
bracketPram16.Surfaces2=[profile19[0]+",FL"]
...
bracketPram17.BaseElement=profile15[0]
...
bracketPram17.Surfaces1=[profile15[0]+",FL"]
bracketPram17.RevSf1=False
bracketPram17.Surfaces2=[profile14[0]+",FL"]
...
bracketPram18.Surfaces1=[profile4[0]+",WF"]
...
bracketPram18.Sf1EndElements=[profile4[1]+",FR"]
...
bracketPram19.BaseElement=profile19[0]
...
bracketPram19.Surfaces2=[profile19[0]+",FL"]
...
bracketPram20.BracketName="HK.Casing.Deck.D.FR13P.CP"
...
bracketPram20.Surfaces1=[profile4[0]+",WB"]
bracketPram20.RevSf1=False
bracketPram20.Surfaces2=[profile5[0]+",FL"]
...
bracketPram21.BracketName="HK.Casing.Deck.D.FR09P.CP"
bracketPram21.MaterialName="SS400"
bracketPram21.BaseElement=profile20[0]
...
bracketPram21.Surfaces2=[profile20[0]+",FL"]
