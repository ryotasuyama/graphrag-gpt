...
# ===== 追加：二つのプロファイルのコーナー(Deck DL02 と FR13P)にブラケットを作成 =====
# 参照プロファイル: profile6[0] (HK.Casing.Deck.D.DL02P) と profile14[0] (HK.Casing.Deck.D.FR13P)
# 基準平面はFR13のフレーム面
bracketPrm_corner = part.CreateBracketParam()
bracketPrm_corner.DefinitionType = 0
bracketPrm_corner.BracketName = "HK.Bkt.Corner.FR13.DL02xFR13P"
bracketPrm_corner.MaterialName = "SS400"
# FR13フレーム位置にある基準平面
bracketPrm_corner.BasePlane = "PL,O," + var_elm6 + "," + "X"
bracketPrm_corner.BasePlaneOffset = "0"
bracketPrm_corner.UseSideSheetForPlane = False
bracketPrm_corner.Mold = "+"
bracketPrm_corner.Thickness = "10"
# コーナーブラケットタイプの一例(サンプルに倣い1501を使用)
bracketPrm_corner.BracketType = 1501
# スカラップ設定(必要に応じて調整)
bracketPrm_corner.Scallop1Type = 1801
bracketPrm_corner.Scallop1Params = ["0"]
bracketPrm_corner.Scallop2Type = 0
# 取付面1: DL02のウェブ面(条材のPLS指定)
bracketPrm_corner.Surfaces1 = ["PLS","True","False","0","-0","1",profile6[0]]
bracketPrm_corner.RevSf1 = False
# 取付面2: FR13Pのウェブ/フランジ面側(条材のPLS指定)
bracketPrm_corner.Surfaces2 = ["PLS","True","False","0","-0","1",profile14[0]]
bracketPrm_corner.RevSf2 = False
bracketPrm_corner.RevSf3 = False
# 寸法タイプ(サンプル準拠の1531: 長さ/逃げ等の簡易指定)
bracketPrm_corner.Sf1DimensionType = 1531
bracketPrm_corner.Sf2DimensionType = 1531
bracket_corner = part.CreateBracket(bracketPrm_corner, False)
# 表示設定(目視しやすいように半透明の黄色)
part.SetElementColor(bracket_corner,"255","215","0","0.4")